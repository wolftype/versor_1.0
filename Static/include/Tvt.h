		#ifndef TVT_H_INCLUDED
		#define TVT_H_INCLUDED
		
		#include "vsr_typedefs.h"
		
		namespace vsr{
	 
inline Tvt gp (const Tvt& a, const Sca& b) { 
	return Tvt (
a[0] * b[0],
a[1] * b[0],
a[2] * b[0],
...
template<> inline MVBase gp_gen<Tvt, Sca> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Sca*)(&b));
}			
		 
inline Par_Tnb gp (const Tvt& a, const Ori& b) { 
	return Par_Tnb (
 - a[7] * b[0],
 - a[8] * b[0],
 - a[9] * b[0],
...
template<> inline MVBase gp_gen<Tvt, Ori> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Ori*)(&b));
}			
		 
inline Inf_Par gp (const Tvt& a, const Inf& b) { 
	return Inf_Par (
 - a[4] * b[0],
 - a[5] * b[0],
 - a[6] * b[0],
...
template<> inline MVBase gp_gen<Tvt, Inf> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Inf*)(&b));
}			
		 
inline Tvt gp (const Tvt& a, const Mnk& b) { 
	return Tvt (
a[10] * b[0],
a[11] * b[0],
a[12] * b[0],
...
template<> inline MVBase gp_gen<Tvt, Mnk> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Mnk*)(&b));
}			
		 
inline Rtc gp (const Tvt& a, const Hyp& b) { 
	return Rtc (
 - a[4] * b[1] - a[7] * b[0],
 - a[5] * b[1] - a[8] * b[0],
 - a[6] * b[1] - a[9] * b[0],
...
template<> inline MVBase gp_gen<Tvt, Hyp> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Hyp*)(&b));
}			
		 
inline Par_Dfp gp (const Tvt& a, const Pss& b) { 
	return Par_Dfp (
 - a[13] * b[0],
a[12] * b[0],
 - a[11] * b[0],
...
template<> inline MVBase gp_gen<Tvt, Pss> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Pss*)(&b));
}			
		 
inline Rtc gp (const Tvt& a, const Pnt& b) { 
	return Rtc (
...
a[1] * b[4] - a[7] * b[1] + a[8] * b[0] + a[11] * b[4] - a[14] * b[2],
a[2] * b[4] - a[7] * b[2] + a[9] * b[0] + a[12] * b[4] + a[14] * b[1],
a[3] * b[4] - a[8] * b[2] + a[9] * b[1] + a[13] * b[4] - a[14] * b[0],
...
template<> inline MVBase gp_gen<Tvt, Pnt> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Pnt*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Par& b) { 
	return Mtt (
 - a[1] * b[0] - a[2] * b[1] - a[3] * b[2] + a[4] * b[6] + a[5] * b[7] + a[6] * b[8] + a[7] * b[3] + a[8] * b[4] + a[9] * b[5] + a[10] * b[9],
a[0] * b[0] - a[2] * b[2] + a[3] * b[1] + a[4] * b[7] - a[5] * b[6] + a[7] * b[4] - a[8] * b[3] + a[11] * b[9] + a[14] * b[5],
a[0] * b[1] + a[1] * b[2] - a[3] * b[0] + a[4] * b[8] - a[6] * b[6] + a[7] * b[5] - a[9] * b[3] + a[12] * b[9] - a[14] * b[4],
a[0] * b[2] - a[1] * b[1] + a[2] * b[0] + a[5] * b[8] - a[6] * b[7] + a[8] * b[5] - a[9] * b[4] + a[13] * b[9] + a[14] * b[3],
...
a[0] * b[6] + a[1] * b[7] + a[2] * b[8] - a[7] * b[9] - a[8] * b[0] - a[9] * b[1] + a[10] * b[6] + a[11] * b[7] + a[12] * b[8] - a[14] * b[2],
a[0] * b[7] - a[1] * b[6] + a[3] * b[8] + a[7] * b[0] - a[8] * b[9] - a[9] * b[2] + a[10] * b[7] - a[11] * b[6] + a[13] * b[8] + a[14] * b[1],
a[0] * b[8] - a[2] * b[6] - a[3] * b[7] + a[7] * b[1] + a[8] * b[2] - a[9] * b[9] + a[10] * b[8] - a[12] * b[6] - a[13] * b[7] - a[14] * b[0],
a[0] * b[9] - a[4] * b[6] - a[5] * b[7] - a[6] * b[8] + a[7] * b[3] + a[8] * b[4] + a[9] * b[5] - a[11] * b[0] - a[12] * b[1] - a[13] * b[2],
a[1] * b[9] - a[4] * b[7] + a[5] * b[6] + a[7] * b[4] - a[8] * b[3] + a[10] * b[0] - a[12] * b[2] + a[13] * b[1] + a[14] * b[5],
a[2] * b[9] - a[4] * b[8] + a[6] * b[6] + a[7] * b[5] - a[9] * b[3] + a[10] * b[1] + a[11] * b[2] - a[13] * b[0] - a[14] * b[4],
a[3] * b[9] - a[5] * b[8] + a[6] * b[7] + a[8] * b[5] - a[9] * b[4] + a[10] * b[2] - a[11] * b[1] + a[12] * b[0] + a[14] * b[3],
a[1] * b[5] - a[2] * b[4] + a[3] * b[3] + a[4] * b[2] - a[5] * b[1] + a[6] * b[0] - a[11] * b[5] + a[12] * b[4] - a[13] * b[3],
a[1] * b[8] - a[2] * b[7] + a[3] * b[6] + a[7] * b[2] - a[8] * b[1] + a[9] * b[0] + a[11] * b[8] - a[12] * b[7] + a[13] * b[6] - a[14] * b[9]
);
}			
		 
		
template<> inline MVBase gp_gen<Tvt, Par> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Par*)(&b));
}			
		 
inline Rtc gp (const Tvt& a, const Cir& b) { 
	return Rtc (
 - a[3] * b[9] + a[5] * b[3] + a[6] * b[4] + a[8] * b[0] + a[9] * b[1] + a[10] * b[6] + a[11] * b[7] + a[12] * b[8] + a[14] * b[2],
a[2] * b[9] - a[4] * b[3] + a[6] * b[5] - a[7] * b[0] + a[9] * b[2] + a[10] * b[7] - a[11] * b[6] + a[13] * b[8] - a[14] * b[1],
 - a[1] * b[9] - a[4] * b[4] - a[5] * b[5] - a[7] * b[1] - a[8] * b[2] + a[10] * b[8] - a[12] * b[6] - a[13] * b[7] + a[14] * b[0],
 - a[1] * b[0] - a[2] * b[1] - a[3] * b[2] - a[4] * b[6] - a[5] * b[7] - a[6] * b[8] + a[11] * b[0] + a[12] * b[1] + a[13] * b[2],
 - a[1] * b[3] - a[2] * b[4] - a[3] * b[5] + a[7] * b[6] + a[8] * b[7] + a[9] * b[8] - a[11] * b[3] - a[12] * b[4] - a[13] * b[5] + a[14] * b[9],
...
a[0] * b[3] - a[2] * b[5] + a[3] * b[4] + a[7] * b[7] - a[8] * b[6] - a[9] * b[9] + a[10] * b[3] - a[12] * b[5] + a[13] * b[4] + a[14] * b[8],
a[0] * b[4] + a[1] * b[5] - a[3] * b[3] + a[7] * b[8] + a[8] * b[9] - a[9] * b[6] + a[10] * b[4] + a[11] * b[5] - a[13] * b[3] - a[14] * b[7],
a[0] * b[5] - a[1] * b[4] + a[2] * b[3] - a[7] * b[9] + a[8] * b[8] - a[9] * b[7] + a[10] * b[5] - a[11] * b[4] + a[12] * b[3] + a[14] * b[6],
a[0] * b[6] + a[1] * b[7] + a[2] * b[8] - a[5] * b[3] - a[6] * b[4] + a[8] * b[0] + a[9] * b[1] - a[13] * b[9] + a[14] * b[2],
a[0] * b[7] - a[1] * b[6] + a[3] * b[8] + a[4] * b[3] - a[6] * b[5] - a[7] * b[0] + a[9] * b[2] + a[12] * b[9] - a[14] * b[1],
a[0] * b[8] - a[2] * b[6] - a[3] * b[7] + a[4] * b[4] + a[5] * b[5] - a[7] * b[1] - a[8] * b[2] - a[11] * b[9] + a[14] * b[0],
...
template<> inline MVBase gp_gen<Tvt, Cir> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Cir*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Sph& b) { 
	return Mtt (
...
a[2] * b[3] + a[4] * b[0] - a[6] * b[2] - a[12] * b[3],
 ...
 - a[3] * b[4] + a[8] * b[0] + a[9] * b[1] - a[13] * b[4] + a[14] * b[2],
a[2] * b[4] - a[7] * b[0] + a[9] * b[2] + a[12] * b[4] - a[14] * b[1],
 - a[1] * b[4] - a[7] * b[1] - a[8] * b[2] - a[11] * b[4] + a[14] * b[0],
...
template<> inline MVBase gp_gen<Tvt, Sph> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Sph*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Sta& b) { 
	return Mtt (
 - a[1] * b[0] - a[2] * b[1] - a[3] * b[2] + a[4] * b[6] + a[5] * b[7] + a[6] * b[8] + a[7] * b[3] + a[8] * b[4] + a[9] * b[5],
a[0] * b[0] - a[2] * b[2] + a[3] * b[1] + a[4] * b[7] - a[5] * b[6] + a[7] * b[4] - a[8] * b[3] + a[14] * b[5],
a[0] * b[1] + a[1] * b[2] - a[3] * b[0] + a[4] * b[8] - a[6] * b[6] + a[7] * b[5] - a[9] * b[3] - a[14] * b[4],
a[0] * b[2] - a[1] * b[1] + a[2] * b[0] + a[5] * b[8] - a[6] * b[7] + a[8] * b[5] - a[9] * b[4] + a[14] * b[3],
...
a[0] * b[6] + a[1] * b[7] + a[2] * b[8] - a[8] * b[0] - a[9] * b[1] + a[10] * b[6] + a[11] * b[7] + a[12] * b[8] - a[14] * b[2],
a[0] * b[7] - a[1] * b[6] + a[3] * b[8] + a[7] * b[0] - a[9] * b[2] + a[10] * b[7] - a[11] * b[6] + a[13] * b[8] + a[14] * b[1],
a[0] * b[8] - a[2] * b[6] - a[3] * b[7] + a[7] * b[1] + a[8] * b[2] + a[10] * b[8] - a[12] * b[6] - a[13] * b[7] - a[14] * b[0],
 - a[4] * b[6] - a[5] * b[7] - a[6] * b[8] + a[7] * b[3] + a[8] * b[4] + a[9] * b[5] - a[11] * b[0] - a[12] * b[1] - a[13] * b[2],
 - a[4] * b[7] + a[5] * b[6] + a[7] * b[4] - a[8] * b[3] + a[10] * b[0] - a[12] * b[2] + a[13] * b[1] + a[14] * b[5],
 - a[4] * b[8] + a[6] * b[6] + a[7] * b[5] - a[9] * b[3] + a[10] * b[1] + a[11] * b[2] - a[13] * b[0] - a[14] * b[4],
 - a[5] * b[8] + a[6] * b[7] + a[8] * b[5] - a[9] * b[4] + a[10] * b[2] - a[11] * b[1] + a[12] * b[0] + a[14] * b[3],
a[1] * b[5] - a[2] * b[4] + a[3] * b[3] + a[4] * b[2] - a[5] * b[1] + a[6] * b[0] - a[11] * b[5] + a[12] * b[4] - a[13] * b[3],
...
template<> inline MVBase gp_gen<Tvt, Sta> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Sta*)(&b));
}			
		 
inline Mtd gp (const Tvt& a, const Drv& b) { 
	return Mtd (
...
template<> inline MVBase gp_gen<Tvt, Drv> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Drv*)(&b));
}			
		 
inline Par_Drb gp (const Tvt& a, const Drb& b) { 
	return Par_Drb (
a[5] * b[0] + a[6] * b[1],
 - a[4] * b[0] + a[6] * b[2],
 - a[4] * b[1] - a[5] * b[2],
...
template<> inline MVBase gp_gen<Tvt, Drb> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Drb*)(&b));
}			
		 
inline Inf_Cir gp (const Tvt& a, const Drt& b) { 
	return Inf_Cir (
a[6] * b[0],
 - a[5] * b[0],
a[4] * b[0],
...
template<> inline MVBase gp_gen<Tvt, Drt> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Drt*)(&b));
}			
		 
inline Rvd gp (const Tvt& a, const Tnv& b) { 
	return Rvd (
a[7] * b[0] + a[8] * b[1] + a[9] * b[2],
a[7] * b[1] - a[8] * b[0] + a[14] * b[2],
a[7] * b[2] - a[9] * b[0] - a[14] * b[1],
a[8] * b[2] - a[9] * b[1] + a[14] * b[0],
a[0] * b[0] + a[1] * b[1] + a[2] * b[2] - a[10] * b[0] - a[11] * b[1] - a[12] * b[2],
a[0] * b[1] - a[1] * b[0] + a[3] * b[2] - a[10] * b[1] + a[11] * b[0] - a[13] * b[2],
a[0] * b[2] - a[2] * b[0] - a[3] * b[1] - a[10] * b[2] + a[12] * b[0] + a[13] * b[1],
a[7] * b[0] + a[8] * b[1] + a[9] * b[2],
...
template<> inline MVBase gp_gen<Tvt, Tnv> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Tnv*)(&b));
}			
		 
inline Par_Tnb gp (const Tvt& a, const Tnb& b) { 
	return Par_Tnb (
a[8] * b[0] + a[9] * b[1] + a[14] * b[2],
 - a[7] * b[0] + a[9] * b[2] - a[14] * b[1],
 - a[7] * b[1] - a[8] * b[2] + a[14] * b[0],
 - a[1] * b[0] - a[2] * b[1] - a[3] * b[2] + a[11] * b[0] + a[12] * b[1] + a[13] * b[2],
a[0] * b[0] - a[2] * b[2] + a[3] * b[1] - a[10] * b[0] + a[12] * b[2] - a[13] * b[1],
a[0] * b[1] + a[1] * b[2] - a[3] * b[0] - a[10] * b[1] - a[11] * b[2] + a[13] * b[0],
a[0] * b[2] - a[1] * b[1] + a[2] * b[0] - a[10] * b[2] + a[11] * b[1] - a[12] * b[0],
...
template<> inline MVBase gp_gen<Tvt, Tnb> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Tnb*)(&b));
}			
		 
inline Rvd gp (const Tvt& a, const Tnt& b) { 
	return Rvd (
 - a[14] * b[0],
a[9] * b[0],
 - a[8] * b[0],
...
template<> inline MVBase gp_gen<Tvt, Tnt> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Tnt*)(&b));
}			
		 
inline Rtc gp (const Tvt& a, const Lin& b) { 
	return Rtc (
a[5] * b[0] + a[6] * b[1] + a[10] * b[3] + a[11] * b[4] + a[12] * b[5],
 ...
 - a[4] * b[5] + a[6] * b[3],
 - a[5] * b[5] + a[6] * b[4],
a[0] * b[0] - a[2] * b[2] + a[3] * b[1] + a[7] * b[4] - a[8] * b[3] + a[10] * b[0] - a[12] * b[2] + a[13] * b[1] + a[14] * b[5],
a[0] * b[1] + a[1] * b[2] - a[3] * b[0] + a[7] * b[5] - a[9] * b[3] + a[10] * b[1] + a[11] * b[2] - a[13] * b[0] - a[14] * b[4],
a[0] * b[2] - a[1] * b[1] + a[2] * b[0] + a[8] * b[5] - a[9] * b[4] + a[10] * b[2] - a[11] * b[1] + a[12] * b[0] + a[14] * b[3],
...
template<> inline MVBase gp_gen<Tvt, Lin> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Lin*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Pln& b) { 
	return Mtt (
...
a[4] * b[0] - a[6] * b[2],
a[4] * b[1] + a[5] * b[2],
 - a[3] * b[3] + a[8] * b[0] + a[9] * b[1] - a[13] * b[3] + a[14] * b[2],
a[2] * b[3] - a[7] * b[0] + a[9] * b[2] + a[12] * b[3] - a[14] * b[1],
 - a[1] * b[3] - a[7] * b[1] - a[8] * b[2] - a[11] * b[3] + a[14] * b[0],
...
template<> inline MVBase gp_gen<Tvt, Pln> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Pln*)(&b));
}			
		 
inline Tvt gp (const Tvt& a, const Flp& b) { 
	return Tvt (
...
template<> inline MVBase gp_gen<Tvt, Flp> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Flp*)(&b));
}			
		 
inline Par_Dfp gp (const Tvt& a, const Dfp& b) { 
	return Par_Dfp (
...
template<> inline MVBase gp_gen<Tvt, Dfp> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Dfp*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Dll& b) { 
	return Mtt (
...
a[4] * b[0] - a[6] * b[2],
a[4] * b[1] + a[5] * b[2],
a[0] * b[3] + a[1] * b[4] + a[2] * b[5] - a[8] * b[0] - a[9] * b[1] + a[10] * b[3] + a[11] * b[4] + a[12] * b[5] - a[14] * b[2],
a[0] * b[4] - a[1] * b[3] + a[3] * b[5] + a[7] * b[0] - a[9] * b[2] + a[10] * b[4] - a[11] * b[3] + a[13] * b[5] + a[14] * b[1],
a[0] * b[5] - a[2] * b[3] - a[3] * b[4] + a[7] * b[1] + a[8] * b[2] + a[10] * b[5] - a[12] * b[3] - a[13] * b[4] - a[14] * b[0],
...
template<> inline MVBase gp_gen<Tvt, Dll> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Dll*)(&b));
}			
		 
inline Rtc gp (const Tvt& a, const Dlp& b) { 
	return Rtc (
...
a[0] * b[3] - a[7] * b[0] - a[8] * b[1] - a[9] * b[2] + a[10] * b[3],
 ...
 - a[4] * b[2] + a[6] * b[0],
 - a[5] * b[2] + a[6] * b[1],
a[1] * b[3] - a[7] * b[1] + a[8] * b[0] + a[11] * b[3] - a[14] * b[2],
a[2] * b[3] - a[7] * b[2] + a[9] * b[0] + a[12] * b[3] + a[14] * b[1],
a[3] * b[3] - a[8] * b[2] + a[9] * b[1] + a[13] * b[3] - a[14] * b[0],
...
template<> inline MVBase gp_gen<Tvt, Dlp> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Dlp*)(&b));
}			
		 
inline Rtc gp (const Tvt& a, const Vec& b) { 
	return Rtc (
...
template<> inline MVBase gp_gen<Tvt, Vec> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Vec*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Biv& b) { 
	return Mtt (
 - a[1] * b[0] - a[2] * b[1] - a[3] * b[2],
...
template<> inline MVBase gp_gen<Tvt, Biv> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Biv*)(&b));
}			
		 
inline Par_Dfp gp (const Tvt& a, const Tri& b) { 
	return Par_Dfp (
 - a[3] * b[0],
a[2] * b[0],
 - a[1] * b[0],
...
template<> inline MVBase gp_gen<Tvt, Tri> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Tri*)(&b));
}			
		 
inline Rtc gp (const Tvt& a, const Aff& b) { 
	return Rtc (
...
template<> inline MVBase gp_gen<Tvt, Aff> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Aff*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Afl& b) { 
	return Mtt (
 - a[1] * b[0] - a[2] * b[1] - a[3] * b[2] + a[7] * b[3] + a[8] * b[4] + a[9] * b[5],
a[0] * b[0] - a[2] * b[2] + a[3] * b[1] + a[7] * b[4] - a[8] * b[3] + a[14] * b[5],
a[0] * b[1] + a[1] * b[2] - a[3] * b[0] + a[7] * b[5] - a[9] * b[3] - a[14] * b[4],
a[0] * b[2] - a[1] * b[1] + a[2] * b[0] + a[8] * b[5] - a[9] * b[4] + a[14] * b[3],
a[0] * b[3] + a[1] * b[4] + a[2] * b[5] - a[5] * b[0] - a[6] * b[1] - a[10] * b[3] - a[11] * b[4] - a[12] * b[5],
a[0] * b[4] - a[1] * b[3] + a[3] * b[5] + a[4] * b[0] - a[6] * b[2] - a[10] * b[4] + a[11] * b[3] - a[13] * b[5],
a[0] * b[5] - a[2] * b[3] - a[3] * b[4] + a[4] * b[1] + a[5] * b[2] - a[10] * b[5] + a[12] * b[3] + a[13] * b[4],
 - a[8] * b[0] - a[9] * b[1] - a[14] * b[2],
...
a[7] * b[4] - a[8] * b[3] + a[10] * b[0] - a[12] * b[2] + a[13] * b[1] + a[14] * b[5],
a[7] * b[5] - a[9] * b[3] + a[10] * b[1] + a[11] * b[2] - a[13] * b[0] - a[14] * b[4],
a[8] * b[5] - a[9] * b[4] + a[10] * b[2] - a[11] * b[1] + a[12] * b[0] + a[14] * b[3],
a[1] * b[5] - a[2] * b[4] + a[3] * b[3] + a[4] * b[2] - a[5] * b[1] + a[6] * b[0] - a[11] * b[5] + a[12] * b[4] - a[13] * b[3],
a[7] * b[2] - a[8] * b[1] + a[9] * b[0]
);
}			
...
template<> inline MVBase gp_gen<Tvt, Afl> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Afl*)(&b));
}			
		 
inline Rtc gp (const Tvt& a, const Afp& b) { 
	return Rtc (
 - a[3] * b[3] + a[8] * b[0] + a[9] * b[1] + a[14] * b[2],
a[2] * b[3] - a[7] * b[0] + a[9] * b[2] - a[14] * b[1],
 - a[1] * b[3] - a[7] * b[1] - a[8] * b[2] + a[14] * b[0],
 - a[1] * b[0] - a[2] * b[1] - a[3] * b[2] + a[11] * b[0] + a[12] * b[1] + a[13] * b[2],
a[14] * b[3],
...
a[8] * b[3],
 - a[7] * b[3],
a[8] * b[0] + a[9] * b[1] - a[13] * b[3] + a[14] * b[2],
 - a[7] * b[0] + a[9] * b[2] + a[12] * b[3] - a[14] * b[1],
 - a[7] * b[1] - a[8] * b[2] - a[11] * b[3] + a[14] * b[0],
...
template<> inline MVBase gp_gen<Tvt, Afp> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Afp*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Dap& b) { 
	return Mtt (
a[7] * b[0] + a[8] * b[1] + a[9] * b[2] + a[10] * b[3],
a[7] * b[1] - a[8] * b[0] + a[11] * b[3] + a[14] * b[2],
a[7] * b[2] - a[9] * b[0] + a[12] * b[3] - a[14] * b[1],
a[8] * b[2] - a[9] * b[1] + a[13] * b[3] + a[14] * b[0],
...
a[1] * b[3] + a[7] * b[1] - a[8] * b[0] + a[14] * b[2],
a[2] * b[3] + a[7] * b[2] - a[9] * b[0] - a[14] * b[1],
a[3] * b[3] + a[8] * b[2] - a[9] * b[1] + a[14] * b[0],
a[1] * b[2] - a[2] * b[1] + a[3] * b[0] - a[11] * b[2] + a[12] * b[1] - a[13] * b[0],
 - a[14] * b[3]
);
}			
...
template<> inline MVBase gp_gen<Tvt, Dap> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Dap*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Daf& b) { 
	return Mtt (
 - a[11] * b[0] - a[12] * b[1] - a[13] * b[2] - a[14] * b[3],
...
template<> inline MVBase gp_gen<Tvt, Daf> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Daf*)(&b));
}			
		 
inline Rtc gp (const Tvt& a, const Dal& b) { 
	return Rtc (
a[8] * b[0] + a[9] * b[1] + a[10] * b[3] + a[11] * b[4] + a[12] * b[5] + a[14] * b[2],
 - a[7] * b[0] + a[9] * b[2] + a[10] * b[4] - a[11] * b[3] + a[13] * b[5] - a[14] * b[1],
 - a[7] * b[1] - a[8] * b[2] + a[10] * b[5] - a[12] * b[3] - a[13] * b[4] + a[14] * b[0],
...
a[7] * b[4] - a[8] * b[3] + a[14] * b[5],
a[7] * b[5] - a[9] * b[3] - a[14] * b[4],
a[8] * b[5] - a[9] * b[4] + a[14] * b[3],
a[0] * b[3] + a[1] * b[4] + a[2] * b[5] + a[8] * b[0] + a[9] * b[1] + a[14] * b[2],
a[0] * b[4] - a[1] * b[3] + a[3] * b[5] - a[7] * b[0] + a[9] * b[2] - a[14] * b[1],
a[0] * b[5] - a[2] * b[3] - a[3] * b[4] - a[7] * b[1] - a[8] * b[2] + a[14] * b[0],
...
template<> inline MVBase gp_gen<Tvt, Dal> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Dal*)(&b));
}			
		 
inline Rtc gp (const Tvt& a, const Mnv& b) { 
	return Rtc (
a[10] * b[0] + a[11] * b[1] + a[12] * b[2],
a[10] * b[1] - a[11] * b[0] + a[13] * b[2],
a[10] * b[2] - a[12] * b[0] - a[13] * b[1],
...
template<> inline MVBase gp_gen<Tvt, Mnv> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Mnv*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Rot& b) { 
	return Mtt (
...
a[7] * b[0] - a[8] * b[1] - a[9] * b[2] - a[14] * b[3],
a[7] * b[1] + a[8] * b[0] - a[9] * b[3] + a[14] * b[2],
a[7] * b[2] + a[8] * b[3] + a[9] * b[0] - a[14] * b[1],
...
a[7] * b[3] - a[8] * b[2] + a[9] * b[1] + a[14] * b[0]
);
}			
		 
		
template<> inline MVBase gp_gen<Tvt, Rot> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Rot*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Mot& b) { 
	return Mtt (
...
a[4] * b[1] + a[5] * b[0] - a[6] * b[3],
a[4] * b[2] + a[5] * b[3] + a[6] * b[0],
a[0] * b[4] + a[1] * b[5] + a[2] * b[6] - a[3] * b[7] + a[7] * b[0] - a[8] * b[1] - a[9] * b[2] + a[10] * b[4] + a[11] * b[5] + a[12] * b[6] - a[13] * b[7] - a[14] * b[3],
a[0] * b[5] - a[1] * b[4] + a[2] * b[7] + a[3] * b[6] + a[7] * b[1] + a[8] * b[0] - a[9] * b[3] + a[10] * b[5] - a[11] * b[4] + a[12] * b[7] + a[13] * b[6] + a[14] * b[2],
a[0] * b[6] - a[1] * b[7] - a[2] * b[4] - a[3] * b[5] + a[7] * b[2] + a[8] * b[3] + a[9] * b[0] + a[10] * b[6] - a[11] * b[7] - a[12] * b[4] - a[13] * b[5] - a[14] * b[1],
...
a[4] * b[3] - a[5] * b[2] + a[6] * b[1],
a[0] * b[7] + a[1] * b[6] - a[2] * b[5] + a[3] * b[4] + a[7] * b[3] - a[8] * b[2] + a[9] * b[1] + a[10] * b[7] + a[11] * b[6] - a[12] * b[5] + a[13] * b[4] + a[14] * b[0]
);
}			
		 
		
template<> inline MVBase gp_gen<Tvt, Mot> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Mot*)(&b));
}			
		 
inline Tvt gp (const Tvt& a, const Dil& b) { 
	return Tvt (
a[0] * b[0] + a[10] * b[1],
a[1] * b[0] + a[11] * b[1],
a[2] * b[0] + a[12] * b[1],
...
template<> inline MVBase gp_gen<Tvt, Dil> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Dil*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Trv& b) { 
	return Mtt (
a[0] * b[0] + a[7] * b[1] + a[8] * b[2] + a[9] * b[3],
a[1] * b[0] + a[7] * b[2] - a[8] * b[1] + a[14] * b[3],
a[2] * b[0] + a[7] * b[3] - a[9] * b[1] - a[14] * b[2],
a[3] * b[0] + a[8] * b[3] - a[9] * b[2] + a[14] * b[1],
...
a[7] * b[2] - a[8] * b[1] + a[11] * b[0] + a[14] * b[3],
a[7] * b[3] - a[9] * b[1] + a[12] * b[0] - a[14] * b[2],
a[8] * b[3] - a[9] * b[2] + a[13] * b[0] + a[14] * b[1],
...
template<> inline MVBase gp_gen<Tvt, Trv> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Trv*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Mtd& b) { 
	return Mtt (
...
a[0] * b[4] + a[1] * b[5] + a[2] * b[6] - a[3] * b[11] + a[7] * b[0] - a[7] * b[7] - a[8] * b[1] + a[8] * b[8] - a[9] * b[2] + a[9] * b[9] + a[10] * b[4] + a[11] * b[5] + a[12] * b[6] - a[13] * b[11] - a[14] * b[3] + a[14] * b[10],
a[0] * b[5] - a[1] * b[4] + a[2] * b[11] + a[3] * b[6] + a[7] * b[1] - a[7] * b[8] + a[8] * b[0] - a[8] * b[7] - a[9] * b[3] + a[9] * b[10] + a[10] * b[5] - a[11] * b[4] + a[12] * b[11] + a[13] * b[6] + a[14] * b[2] - a[14] * b[9],
a[0] * b[6] - a[1] * b[11] - a[2] * b[4] - a[3] * b[5] + a[7] * b[2] - a[7] * b[9] + a[8] * b[3] - a[8] * b[10] + a[9] * b[0] - a[9] * b[7] + a[10] * b[6] - a[11] * b[11] - a[12] * b[4] - a[13] * b[5] - a[14] * b[1] + a[14] * b[8],
...
a[0] * b[11] + a[1] * b[6] - a[2] * b[5] + a[3] * b[4] + a[7] * b[3] - a[7] * b[10] - a[8] * b[2] + a[8] * b[9] + a[9] * b[1] - a[9] * b[8] + a[10] * b[11] + a[11] * b[6] - a[12] * b[5] + a[13] * b[4] + a[14] * b[0] - a[14] * b[7]
);
}			
		 
		
template<> inline MVBase gp_gen<Tvt, Mtd> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Mtd*)(&b));
}			
		 
inline Tvt gp (const Tvt& a, const Trs& b) { 
	return Tvt (
...
template<> inline MVBase gp_gen<Tvt, Trs> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Trs*)(&b));
}			
		 
inline Rtc gp (const Tvt& a, const Rtc& b) { 
	return Rtc (
a[0] * b[0] + a[1] * b[1] + a[2] * b[2] - a[3] * b[14] - a[4] * b[4] + a[5] * b[8] + a[6] * b[9] - a[7] * b[3] + a[8] * b[5] + a[9] * b[6] + a[10] * b[11] + a[11] * b[12] + a[12] * b[13] - a[13] * b[15] + a[14] * b[7],
a[0] * b[1] - a[1] * b[0] + a[2] * b[14] + a[3] * b[2] - a[4] * b[8] - a[5] * b[4] + a[6] * b[10] - a[7] * b[5] - a[8] * b[3] + a[9] * b[7] + a[10] * b[12] - a[11] * b[11] + a[12] * b[15] + a[13] * b[13] - a[14] * b[6],
a[0] * b[2] - a[1] * b[14] - a[2] * b[0] - a[3] * b[1] - a[4] * b[9] - a[5] * b[10] - a[6] * b[4] - a[7] * b[6] - a[8] * b[7] - a[9] * b[3] + a[10] * b[13] - a[11] * b[15] - a[12] * b[11] - a[13] * b[12] + a[14] * b[5],
a[0] * b[3] - a[1] * b[5] - a[2] * b[6] - a[3] * b[7] - a[4] * b[0] - a[4] * b[11] - a[5] * b[1] - a[5] * b[12] - a[6] * b[2] - a[6] * b[13] - a[10] * b[3] + a[11] * b[5] + a[12] * b[6] + a[13] * b[7],
a[0] * b[4] - a[1] * b[8] - a[2] * b[9] - a[3] * b[10] - a[7] * b[0] + a[7] * b[11] - a[8] * b[1] + a[8] * b[12] - a[9] * b[2] + a[9] * b[13] + a[10] * b[4] - a[11] * b[8] - a[12] * b[9] - a[13] * b[10] + a[14] * b[14] - a[14] * b[15],
...
a[0] * b[8] + a[1] * b[4] - a[2] * b[10] + a[3] * b[9] - a[7] * b[1] + a[7] * b[12] + a[8] * b[0] - a[8] * b[11] - a[9] * b[14] + a[9] * b[15] + a[10] * b[8] + a[11] * b[4] - a[12] * b[10] + a[13] * b[9] - a[14] * b[2] + a[14] * b[13],
a[0] * b[9] + a[1] * b[10] + a[2] * b[4] - a[3] * b[8] - a[7] * b[2] + a[7] * b[13] + a[8] * b[14] - a[8] * b[15] + a[9] * b[0] - a[9] * b[11] + a[10] * b[9] + a[11] * b[10] + a[12] * b[4] - a[13] * b[8] + a[14] * b[1] - a[14] * b[12],
a[0] * b[10] - a[1] * b[9] + a[2] * b[8] + a[3] * b[4] - a[7] * b[14] + a[7] * b[15] - a[8] * b[2] + a[8] * b[13] + a[9] * b[1] - a[9] * b[12] + a[10] * b[10] - a[11] * b[9] + a[12] * b[8] + a[13] * b[4] - a[14] * b[0] + a[14] * b[11],
a[0] * b[11] + a[1] * b[12] + a[2] * b[13] - a[3] * b[15] + a[4] * b[4] - a[5] * b[8] - a[6] * b[9] - a[7] * b[3] + a[8] * b[5] + a[9] * b[6] + a[10] * b[0] + a[11] * b[1] + a[12] * b[2] - a[13] * b[14] + a[14] * b[7],
a[0] * b[12] - a[1] * b[11] + a[2] * b[15] + a[3] * b[13] + a[4] * b[8] + a[5] * b[4] - a[6] * b[10] - a[7] * b[5] - a[8] * b[3] + a[9] * b[7] + a[10] * b[1] - a[11] * b[0] + a[12] * b[14] + a[13] * b[2] - a[14] * b[6],
a[0] * b[13] - a[1] * b[15] - a[2] * b[11] - a[3] * b[12] + a[4] * b[9] + a[5] * b[10] + a[6] * b[4] - a[7] * b[6] - a[8] * b[7] - a[9] * b[3] + a[10] * b[2] - a[11] * b[14] - a[12] * b[0] - a[13] * b[1] + a[14] * b[5],
a[0] * b[14] + a[1] * b[2] - a[2] * b[1] + a[3] * b[0] - a[4] * b[10] + a[5] * b[9] - a[6] * b[8] - a[7] * b[7] + a[8] * b[6] - a[9] * b[5] + a[10] * b[15] + a[11] * b[13] - a[12] * b[12] + a[13] * b[11] - a[14] * b[3],
a[0] * b[15] + a[1] * b[13] - a[2] * b[12] + a[3] * b[11] + a[4] * b[10] - a[5] * b[9] + a[6] * b[8] - a[7] * b[7] + a[8] * b[6] - a[9] * b[5] + a[10] * b[14] + a[11] * b[2] - a[12] * b[1] + a[13] * b[0] - a[14] * b[3]
);
}			
		 
		
template<> inline MVBase gp_gen<Tvt, Rtc> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Rtc*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Mtt& b) { 
	return Mtt (
...
a[0] * b[1] + a[1] * b[0] - a[2] * b[3] + a[3] * b[2] + a[4] * b[8] - a[5] * b[7] + a[6] * b[15] + a[7] * b[5] - a[8] * b[4] + a[9] * b[14] + a[10] * b[11] + a[11] * b[10] - a[12] * b[13] + a[13] * b[12] + a[14] * b[6],
a[0] * b[2] + a[1] * b[3] + a[2] * b[0] - a[3] * b[1] + a[4] * b[9] - a[5] * b[15] - a[6] * b[7] + a[7] * b[6] - a[8] * b[14] - a[9] * b[4] + a[10] * b[12] + a[11] * b[13] + a[12] * b[10] - a[13] * b[11] - a[14] * b[5],
a[0] * b[3] - a[1] * b[2] + a[2] * b[1] + a[3] * b[0] + a[4] * b[15] + a[5] * b[9] - a[6] * b[8] + a[7] * b[14] + a[8] * b[6] - a[9] * b[5] + a[10] * b[13] - a[11] * b[12] + a[12] * b[11] + a[13] * b[10] + a[14] * b[4],
...
a[0] * b[7] + a[1] * b[8] + a[2] * b[9] - a[3] * b[15] + a[7] * b[0] - a[7] * b[10] - a[8] * b[1] + a[8] * b[11] - a[9] * b[2] + a[9] * b[12] + a[10] * b[7] + a[11] * b[8] + a[12] * b[9] - a[13] * b[15] - a[14] * b[3] + a[14] * b[13],
a[0] * b[8] - a[1] * b[7] + a[2] * b[15] + a[3] * b[9] + a[7] * b[1] - a[7] * b[11] + a[8] * b[0] - a[8] * b[10] - a[9] * b[3] + a[9] * b[13] + a[10] * b[8] - a[11] * b[7] + a[12] * b[15] + a[13] * b[9] + a[14] * b[2] - a[14] * b[12],
a[0] * b[9] - a[1] * b[15] - a[2] * b[7] - a[3] * b[8] + a[7] * b[2] - a[7] * b[12] + a[8] * b[3] - a[8] * b[13] + a[9] * b[0] - a[9] * b[10] + a[10] * b[9] - a[11] * b[15] - a[12] * b[7] - a[13] * b[8] - a[14] * b[1] + a[14] * b[11],
...
a[0] * b[11] + a[1] * b[10] - a[2] * b[13] + a[3] * b[12] - a[4] * b[8] + a[5] * b[7] - a[6] * b[15] + a[7] * b[5] - a[8] * b[4] + a[9] * b[14] + a[10] * b[1] + a[11] * b[0] - a[12] * b[3] + a[13] * b[2] + a[14] * b[6],
a[0] * b[12] + a[1] * b[13] + a[2] * b[10] - a[3] * b[11] - a[4] * b[9] + a[5] * b[15] + a[6] * b[7] + a[7] * b[6] - a[8] * b[14] - a[9] * b[4] + a[10] * b[2] + a[11] * b[3] + a[12] * b[0] - a[13] * b[1] - a[14] * b[5],
a[0] * b[13] - a[1] * b[12] + a[2] * b[11] + a[3] * b[10] - a[4] * b[15] - a[5] * b[9] + a[6] * b[8] + a[7] * b[14] + a[8] * b[6] - a[9] * b[5] + a[10] * b[3] - a[11] * b[2] + a[12] * b[1] + a[13] * b[0] + a[14] * b[4],
a[0] * b[14] + a[1] * b[6] - a[2] * b[5] + a[3] * b[4] + a[4] * b[3] + a[4] * b[13] - a[5] * b[2] - a[5] * b[12] + a[6] * b[1] + a[6] * b[11] - a[10] * b[14] - a[11] * b[6] + a[12] * b[5] - a[13] * b[4],
a[0] * b[15] + a[1] * b[9] - a[2] * b[8] + a[3] * b[7] + a[7] * b[3] - a[7] * b[13] - a[8] * b[2] + a[8] * b[12] + a[9] * b[1] - a[9] * b[11] + a[10] * b[15] + a[11] * b[9] - a[12] * b[8] + a[13] * b[7] + a[14] * b[0] - a[14] * b[10]
);
}			
		 
		
template<> inline MVBase gp_gen<Tvt, Mtt> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Mtt*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Rtt& b) { 
	return Mtt (
a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3] + a[7] * b[4] + a[8] * b[5] + a[9] * b[6] - a[14] * b[7],
a[0] * b[1] + a[1] * b[0] - a[2] * b[3] + a[3] * b[2] + a[7] * b[5] - a[8] * b[4] + a[9] * b[7] + a[14] * b[6],
a[0] * b[2] + a[1] * b[3] + a[2] * b[0] - a[3] * b[1] + a[7] * b[6] - a[8] * b[7] - a[9] * b[4] - a[14] * b[5],
a[0] * b[3] - a[1] * b[2] + a[2] * b[1] + a[3] * b[0] + a[7] * b[7] + a[8] * b[6] - a[9] * b[5] + a[14] * b[4],
...
a[7] * b[1] + a[8] * b[0] - a[9] * b[3] + a[14] * b[2],
a[7] * b[2] + a[8] * b[3] + a[9] * b[0] - a[14] * b[1],
a[7] * b[4] + a[8] * b[5] + a[9] * b[6] + a[10] * b[0] - a[11] * b[1] - a[12] * b[2] - a[13] * b[3] - a[14] * b[7],
a[7] * b[5] - a[8] * b[4] + a[9] * b[7] + a[10] * b[1] + a[11] * b[0] - a[12] * b[3] + a[13] * b[2] + a[14] * b[6],
a[7] * b[6] - a[8] * b[7] - a[9] * b[4] + a[10] * b[2] + a[11] * b[3] + a[12] * b[0] - a[13] * b[1] - a[14] * b[5],
a[7] * b[7] + a[8] * b[6] - a[9] * b[5] + a[10] * b[3] - a[11] * b[2] + a[12] * b[1] + a[13] * b[0] + a[14] * b[4],
...
template<> inline MVBase gp_gen<Tvt, Rtt> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Rtt*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Rtd& b) { 
	return Mtt (
...
a[7] * b[0] - a[7] * b[4] - a[8] * b[1] + a[8] * b[5] - a[9] * b[2] + a[9] * b[6] - a[14] * b[3] + a[14] * b[7],
a[7] * b[1] - a[7] * b[5] + a[8] * b[0] - a[8] * b[4] - a[9] * b[3] + a[9] * b[7] + a[14] * b[2] - a[14] * b[6],
a[7] * b[2] - a[7] * b[6] + a[8] * b[3] - a[8] * b[7] + a[9] * b[0] - a[9] * b[4] - a[14] * b[1] + a[14] * b[5],
...
a[7] * b[3] - a[7] * b[7] - a[8] * b[2] + a[8] * b[6] + a[9] * b[1] - a[9] * b[5] + a[14] * b[0] - a[14] * b[4]
);
}			
		 
		
template<> inline MVBase gp_gen<Tvt, Rtd> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Rtd*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Tvd& b) { 
	return Mtt (
a[0] * b[0] + a[7] * b[1] + a[8] * b[2] + a[9] * b[3] + a[10] * b[4],
a[1] * b[0] + a[7] * b[2] - a[8] * b[1] + a[11] * b[4] + a[14] * b[3],
a[2] * b[0] + a[7] * b[3] - a[9] * b[1] + a[12] * b[4] - a[14] * b[2],
a[3] * b[0] + a[8] * b[3] - a[9] * b[2] + a[13] * b[4] + a[14] * b[1],
...
a[1] * b[4] + a[7] * b[2] - a[8] * b[1] + a[11] * b[0] + a[14] * b[3],
a[2] * b[4] + a[7] * b[3] - a[9] * b[1] + a[12] * b[0] - a[14] * b[2],
a[3] * b[4] + a[8] * b[3] - a[9] * b[2] + a[13] * b[0] + a[14] * b[1],
a[1] * b[3] - a[2] * b[2] + a[3] * b[1] - a[11] * b[3] + a[12] * b[2] - a[13] * b[1],
a[14] * b[0] - a[14] * b[4]
);
}			
...
template<> inline MVBase gp_gen<Tvt, Tvd> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Tvd*)(&b));
}			
		 
inline Tvt gp (const Tvt& a, const Tsd& b) { 
	return Tvt (
...
template<> inline MVBase gp_gen<Tvt, Tsd> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Tsd*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Trt& b) { 
	return Mtt (
a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3] + a[4] * b[7] + a[5] * b[8] + a[6] * b[9] + a[7] * b[4] + a[8] * b[5] + a[9] * b[6] + a[10] * b[10] - a[11] * b[11] - a[12] * b[12] - a[13] * b[13],
a[0] * b[1] + a[1] * b[0] - a[2] * b[3] + a[3] * b[2] + a[4] * b[8] - a[5] * b[7] + a[7] * b[5] - a[8] * b[4] + a[10] * b[11] + a[11] * b[10] - a[12] * b[13] + a[13] * b[12] + a[14] * b[6],
a[0] * b[2] + a[1] * b[3] + a[2] * b[0] - a[3] * b[1] + a[4] * b[9] - a[6] * b[7] + a[7] * b[6] - a[9] * b[4] + a[10] * b[12] + a[11] * b[13] + a[12] * b[10] - a[13] * b[11] - a[14] * b[5],
a[0] * b[3] - a[1] * b[2] + a[2] * b[1] + a[3] * b[0] + a[5] * b[9] - a[6] * b[8] + a[8] * b[6] - a[9] * b[5] + a[10] * b[13] - a[11] * b[12] + a[12] * b[11] + a[13] * b[10] + a[14] * b[4],
...
a[0] * b[7] + a[1] * b[8] + a[2] * b[9] + a[7] * b[0] - a[7] * b[10] - a[8] * b[1] + a[8] * b[11] - a[9] * b[2] + a[9] * b[12] + a[10] * b[7] + a[11] * b[8] + a[12] * b[9] - a[14] * b[3] + a[14] * b[13],
a[0] * b[8] - a[1] * b[7] + a[3] * b[9] + a[7] * b[1] - a[7] * b[11] + a[8] * b[0] - a[8] * b[10] - a[9] * b[3] + a[9] * b[13] + a[10] * b[8] - a[11] * b[7] + a[13] * b[9] + a[14] * b[2] - a[14] * b[12],
a[0] * b[9] - a[2] * b[7] - a[3] * b[8] + a[7] * b[2] - a[7] * b[12] + a[8] * b[3] - a[8] * b[13] + a[9] * b[0] - a[9] * b[10] + a[10] * b[9] - a[12] * b[7] - a[13] * b[8] - a[14] * b[1] + a[14] * b[11],
a[0] * b[10] - a[1] * b[11] - a[2] * b[12] - a[3] * b[13] - a[4] * b[7] - a[5] * b[8] - a[6] * b[9] + a[7] * b[4] + a[8] * b[5] + a[9] * b[6] + a[10] * b[0] - a[11] * b[1] - a[12] * b[2] - a[13] * b[3],
a[0] * b[11] + a[1] * b[10] - a[2] * b[13] + a[3] * b[12] - a[4] * b[8] + a[5] * b[7] + a[7] * b[5] - a[8] * b[4] + a[10] * b[1] + a[11] * b[0] - a[12] * b[3] + a[13] * b[2] + a[14] * b[6],
a[0] * b[12] + a[1] * b[13] + a[2] * b[10] - a[3] * b[11] - a[4] * b[9] + a[6] * b[7] + a[7] * b[6] - a[9] * b[4] + a[10] * b[2] + a[11] * b[3] + a[12] * b[0] - a[13] * b[1] - a[14] * b[5],
a[0] * b[13] - a[1] * b[12] + a[2] * b[11] + a[3] * b[10] - a[5] * b[9] + a[6] * b[8] + a[8] * b[6] - a[9] * b[5] + a[10] * b[3] - a[11] * b[2] + a[12] * b[1] + a[13] * b[0] + a[14] * b[4],
a[1] * b[6] - a[2] * b[5] + a[3] * b[4] + a[4] * b[3] + a[4] * b[13] - a[5] * b[2] - a[5] * b[12] + a[6] * b[1] + a[6] * b[11] - a[11] * b[6] + a[12] * b[5] - a[13] * b[4],
a[1] * b[9] - a[2] * b[8] + a[3] * b[7] + a[7] * b[3] - a[7] * b[13] - a[8] * b[2] + a[8] * b[12] + a[9] * b[1] - a[9] * b[11] + a[11] * b[9] - a[12] * b[8] + a[13] * b[7] + a[14] * b[0] - a[14] * b[10]
);
}			
		 
		
template<> inline MVBase gp_gen<Tvt, Trt> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Trt*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Rvd& b) { 
	return Mtt (
a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3] + a[7] * b[4] + a[8] * b[5] + a[9] * b[6] + a[10] * b[7] - a[11] * b[8] - a[12] * b[9] - a[13] * b[10] - a[14] * b[11],
a[0] * b[1] + a[1] * b[0] - a[2] * b[3] + a[3] * b[2] + a[7] * b[5] - a[8] * b[4] + a[9] * b[11] + a[10] * b[8] + a[11] * b[7] - a[12] * b[10] + a[13] * b[9] + a[14] * b[6],
a[0] * b[2] + a[1] * b[3] + a[2] * b[0] - a[3] * b[1] + a[7] * b[6] - a[8] * b[11] - a[9] * b[4] + a[10] * b[9] + a[11] * b[10] + a[12] * b[7] - a[13] * b[8] - a[14] * b[5],
a[0] * b[3] - a[1] * b[2] + a[2] * b[1] + a[3] * b[0] + a[7] * b[11] + a[8] * b[6] - a[9] * b[5] + a[10] * b[10] - a[11] * b[9] + a[12] * b[8] + a[13] * b[7] + a[14] * b[4],
...
a[7] * b[0] - a[7] * b[7] - a[8] * b[1] + a[8] * b[8] - a[9] * b[2] + a[9] * b[9] - a[14] * b[3] + a[14] * b[10],
a[7] * b[1] - a[7] * b[8] + a[8] * b[0] - a[8] * b[7] - a[9] * b[3] + a[9] * b[10] + a[14] * b[2] - a[14] * b[9],
a[7] * b[2] - a[7] * b[9] + a[8] * b[3] - a[8] * b[10] + a[9] * b[0] - a[9] * b[7] - a[14] * b[1] + a[14] * b[8],
a[0] * b[7] - a[1] * b[8] - a[2] * b[9] - a[3] * b[10] + a[7] * b[4] + a[8] * b[5] + a[9] * b[6] + a[10] * b[0] - a[11] * b[1] - a[12] * b[2] - a[13] * b[3] - a[14] * b[11],
a[0] * b[8] + a[1] * b[7] - a[2] * b[10] + a[3] * b[9] + a[7] * b[5] - a[8] * b[4] + a[9] * b[11] + a[10] * b[1] + a[11] * b[0] - a[12] * b[3] + a[13] * b[2] + a[14] * b[6],
a[0] * b[9] + a[1] * b[10] + a[2] * b[7] - a[3] * b[8] + a[7] * b[6] - a[8] * b[11] - a[9] * b[4] + a[10] * b[2] + a[11] * b[3] + a[12] * b[0] - a[13] * b[1] - a[14] * b[5],
a[0] * b[10] - a[1] * b[9] + a[2] * b[8] + a[3] * b[7] + a[7] * b[11] + a[8] * b[6] - a[9] * b[5] + a[10] * b[3] - a[11] * b[2] + a[12] * b[1] + a[13] * b[0] + a[14] * b[4],
a[0] * b[11] + a[1] * b[6] - a[2] * b[5] + a[3] * b[4] + a[4] * b[3] + a[4] * b[10] - a[5] * b[2] - a[5] * b[9] + a[6] * b[1] + a[6] * b[8] - a[10] * b[11] - a[11] * b[6] + a[12] * b[5] - a[13] * b[4],
a[7] * b[3] - a[7] * b[10] - a[8] * b[2] + a[8] * b[9] + a[9] * b[1] - a[9] * b[8] + a[14] * b[0] - a[14] * b[7]
);
}			
		 
		
template<> inline MVBase gp_gen<Tvt, Rvd> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Rvd*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Tst& b) { 
	return Mtt (
a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3] + a[4] * b[7] + a[5] * b[8] + a[6] * b[9] + a[7] * b[4] + a[8] * b[5] + a[9] * b[6] + a[10] * b[10] - a[11] * b[11] - a[12] * b[12] - a[13] * b[13] - a[14] * b[14],
a[0] * b[1] + a[1] * b[0] - a[2] * b[3] + a[3] * b[2] + a[4] * b[8] - a[5] * b[7] + a[7] * b[5] - a[8] * b[4] + a[9] * b[14] + a[10] * b[11] + a[11] * b[10] - a[12] * b[13] + a[13] * b[12] + a[14] * b[6],
a[0] * b[2] + a[1] * b[3] + a[2] * b[0] - a[3] * b[1] + a[4] * b[9] - a[6] * b[7] + a[7] * b[6] - a[8] * b[14] - a[9] * b[4] + a[10] * b[12] + a[11] * b[13] + a[12] * b[10] - a[13] * b[11] - a[14] * b[5],
a[0] * b[3] - a[1] * b[2] + a[2] * b[1] + a[3] * b[0] + a[5] * b[9] - a[6] * b[8] + a[7] * b[14] + a[8] * b[6] - a[9] * b[5] + a[10] * b[13] - a[11] * b[12] + a[12] * b[11] + a[13] * b[10] + a[14] * b[4],
a[0] * b[4] + a[1] * b[5] + a[2] * b[6] - a[3] * b[14] + a[4] * b[0] + a[4] * b[10] - a[5] * b[1] - a[5] * b[11] - a[6] * b[2] - a[6] * b[12] - a[10] * b[4] - a[11] * b[5] - a[12] * b[6] + a[13] * b[14],
a[0] * b[5] - a[1] * b[4] + a[2] * b[14] + a[3] * b[6] + a[4] * b[1] + a[4] * b[11] + a[5] * b[0] + a[5] * b[10] - a[6] * b[3] - a[6] * b[13] - a[10] * b[5] + a[11] * b[4] - a[12] * b[14] - a[13] * b[6],
a[0] * b[6] - a[1] * b[14] - a[2] * b[4] - a[3] * b[5] + a[4] * b[2] + a[4] * b[12] + a[5] * b[3] + a[5] * b[13] + a[6] * b[0] + a[6] * b[10] - a[10] * b[6] + a[11] * b[14] + a[12] * b[4] + a[13] * b[5],
a[0] * b[7] + a[1] * b[8] + a[2] * b[9] + a[7] * b[0] - a[7] * b[10] - a[8] * b[1] + a[8] * b[11] - a[9] * b[2] + a[9] * b[12] + a[10] * b[7] + a[11] * b[8] + a[12] * b[9] - a[14] * b[3] + a[14] * b[13],
...
a[0] * b[9] - a[2] * b[7] - a[3] * b[8] + a[7] * b[2] - a[7] * b[12] + a[8] * b[3] - a[8] * b[13] + a[9] * b[0] - a[9] * b[10] + a[10] * b[9] - a[12] * b[7] - a[13] * b[8] - a[14] * b[1] + a[14] * b[11],
a[0] * b[10] - a[1] * b[11] - a[2] * b[12] - a[3] * b[13] - a[4] * b[7] - a[5] * b[8] - a[6] * b[9] + a[7] * b[4] + a[8] * b[5] + a[9] * b[6] + a[10] * b[0] - a[11] * b[1] - a[12] * b[2] - a[13] * b[3] - a[14] * b[14],
a[0] * b[11] + a[1] * b[10] - a[2] * b[13] + a[3] * b[12] - a[4] * b[8] + a[5] * b[7] + a[7] * b[5] - a[8] * b[4] + a[9] * b[14] + a[10] * b[1] + a[11] * b[0] - a[12] * b[3] + a[13] * b[2] + a[14] * b[6],
a[0] * b[12] + a[1] * b[13] + a[2] * b[10] - a[3] * b[11] - a[4] * b[9] + a[6] * b[7] + a[7] * b[6] - a[8] * b[14] - a[9] * b[4] + a[10] * b[2] + a[11] * b[3] + a[12] * b[0] - a[13] * b[1] - a[14] * b[5],
a[0] * b[13] - a[1] * b[12] + a[2] * b[11] + a[3] * b[10] - a[5] * b[9] + a[6] * b[8] + a[7] * b[14] + a[8] * b[6] - a[9] * b[5] + a[10] * b[3] - a[11] * b[2] + a[12] * b[1] + a[13] * b[0] + a[14] * b[4],
a[0] * b[14] + a[1] * b[6] - a[2] * b[5] + a[3] * b[4] + a[4] * b[3] + a[4] * b[13] - a[5] * b[2] - a[5] * b[12] + a[6] * b[1] + a[6] * b[11] - a[10] * b[14] - a[11] * b[6] + a[12] * b[5] - a[13] * b[4],
a[1] * b[9] - a[2] * b[8] + a[3] * b[7] + a[7] * b[3] - a[7] * b[13] - a[8] * b[2] + a[8] * b[12] + a[9] * b[1] - a[9] * b[11] + a[11] * b[9] - a[12] * b[8] + a[13] * b[7] + a[14] * b[0] - a[14] * b[10]
);
}			
...
template<> inline MVBase gp_gen<Tvt, Tst> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Tst*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Tvt& b) { 
	return Mtt (
a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3] + a[4] * b[7] + a[5] * b[8] + a[6] * b[9] + a[7] * b[4] + a[8] * b[5] + a[9] * b[6] + a[10] * b[10] - a[11] * b[11] - a[12] * b[12] - a[13] * b[13],
a[0] * b[1] + a[1] * b[0] - a[2] * b[3] + a[3] * b[2] + a[4] * b[8] - a[5] * b[7] + a[6] * b[14] + a[7] * b[5] - a[8] * b[4] + a[10] * b[11] + a[11] * b[10] - a[12] * b[13] + a[13] * b[12] + a[14] * b[6],
a[0] * b[2] + a[1] * b[3] + a[2] * b[0] - a[3] * b[1] + a[4] * b[9] - a[5] * b[14] - a[6] * b[7] + a[7] * b[6] - a[9] * b[4] + a[10] * b[12] + a[11] * b[13] + a[12] * b[10] - a[13] * b[11] - a[14] * b[5],
a[0] * b[3] - a[1] * b[2] + a[2] * b[1] + a[3] * b[0] + a[4] * b[14] + a[5] * b[9] - a[6] * b[8] + a[8] * b[6] - a[9] * b[5] + a[10] * b[13] - a[11] * b[12] + a[12] * b[11] + a[13] * b[10] + a[14] * b[4],
a[0] * b[4] + a[1] * b[5] + a[2] * b[6] + a[4] * b[0] + a[4] * b[10] - a[5] * b[1] - a[5] * b[11] - a[6] * b[2] - a[6] * b[12] - a[10] * b[4] - a[11] * b[5] - a[12] * b[6],
a[0] * b[5] - a[1] * b[4] + a[3] * b[6] + a[4] * b[1] + a[4] * b[11] + a[5] * b[0] + a[5] * b[10] - a[6] * b[3] - a[6] * b[13] - a[10] * b[5] + a[11] * b[4] - a[13] * b[6],
a[0] * b[6] - a[2] * b[4] - a[3] * b[5] + a[4] * b[2] + a[4] * b[12] + a[5] * b[3] + a[5] * b[13] + a[6] * b[0] + a[6] * b[10] - a[10] * b[6] + a[12] * b[4] + a[13] * b[5],
a[0] * b[7] + a[1] * b[8] + a[2] * b[9] - a[3] * b[14] + a[7] * b[0] - a[7] * b[10] - a[8] * b[1] + a[8] * b[11] - a[9] * b[2] + a[9] * b[12] + a[10] * b[7] + a[11] * b[8] + a[12] * b[9] - a[13] * b[14] - a[14] * b[3] + a[14] * b[13],
a[0] * b[8] - a[1] * b[7] + a[2] * b[14] + a[3] * b[9] + a[7] * b[1] - a[7] * b[11] + a[8] * b[0] - a[8] * b[10] - a[9] * b[3] + a[9] * b[13] + a[10] * b[8] - a[11] * b[7] + a[12] * b[14] + a[13] * b[9] + a[14] * b[2] - a[14] * b[12],
a[0] * b[9] - a[1] * b[14] - a[2] * b[7] - a[3] * b[8] + a[7] * b[2] - a[7] * b[12] + a[8] * b[3] - a[8] * b[13] + a[9] * b[0] - a[9] * b[10] + a[10] * b[9] - a[11] * b[14] - a[12] * b[7] - a[13] * b[8] - a[14] * b[1] + a[14] * b[11],
a[0] * b[10] - a[1] * b[11] - a[2] * b[12] - a[3] * b[13] - a[4] * b[7] - a[5] * b[8] - a[6] * b[9] + a[7] * b[4] + a[8] * b[5] + a[9] * b[6] + a[10] * b[0] - a[11] * b[1] - a[12] * b[2] - a[13] * b[3],
a[0] * b[11] + a[1] * b[10] - a[2] * b[13] + a[3] * b[12] - a[4] * b[8] + a[5] * b[7] - a[6] * b[14] + a[7] * b[5] - a[8] * b[4] + a[10] * b[1] + a[11] * b[0] - a[12] * b[3] + a[13] * b[2] + a[14] * b[6],
a[0] * b[12] + a[1] * b[13] + a[2] * b[10] - a[3] * b[11] - a[4] * b[9] + a[5] * b[14] + a[6] * b[7] + a[7] * b[6] - a[9] * b[4] + a[10] * b[2] + a[11] * b[3] + a[12] * b[0] - a[13] * b[1] - a[14] * b[5],
a[0] * b[13] - a[1] * b[12] + a[2] * b[11] + a[3] * b[10] - a[4] * b[14] - a[5] * b[9] + a[6] * b[8] + a[8] * b[6] - a[9] * b[5] + a[10] * b[3] - a[11] * b[2] + a[12] * b[1] + a[13] * b[0] + a[14] * b[4],
a[1] * b[6] - a[2] * b[5] + a[3] * b[4] + a[4] * b[3] + a[4] * b[13] - a[5] * b[2] - a[5] * b[12] + a[6] * b[1] + a[6] * b[11] - a[11] * b[6] + a[12] * b[5] - a[13] * b[4],
a[0] * b[14] + a[1] * b[9] - a[2] * b[8] + a[3] * b[7] + a[7] * b[3] - a[7] * b[13] - a[8] * b[2] + a[8] * b[12] + a[9] * b[1] - a[9] * b[11] + a[10] * b[14] + a[11] * b[9] - a[12] * b[8] + a[13] * b[7] + a[14] * b[0] - a[14] * b[10]
);
}			
		 
		
template<> inline MVBase gp_gen<Tvt, Tvt> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Tvt*)(&b));
}			
		 
inline Mtt gp (const Tvt& a, const Bst& b) { 
	return Mtt (
a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3] + a[4] * b[7] + a[5] * b[8] + a[6] * b[9] + a[7] * b[4] + a[8] * b[5] + a[9] * b[6] + a[10] * b[10],
a[0] * b[1] + a[1] * b[0] - a[2] * b[3] + a[3] * b[2] + a[4] * b[8] - a[5] * b[7] + a[7] * b[5] - a[8] * b[4] + a[11] * b[10] + a[14] * b[6],
a[0] * b[2] + a[1] * b[3] + a[2] * b[0] - a[3] * b[1] + a[4] * b[9] - a[6] * b[7] + a[7] * b[6] - a[9] * b[4] + a[12] * b[10] - a[14] * b[5],
a[0] * b[3] - a[1] * b[2] + a[2] * b[1] + a[3] * b[0] + a[5] * b[9] - a[6] * b[8] + a[8] * b[6] - a[9] * b[5] + a[13] * b[10] + a[14] * b[4],
...
a[0] * b[7] + a[1] * b[8] + a[2] * b[9] + a[7] * b[0] - a[7] * b[10] - a[8] * b[1] - a[9] * b[2] + a[10] * b[7] + a[11] * b[8] + a[12] * b[9] - a[14] * b[3],
a[0] * b[8] - a[1] * b[7] + a[3] * b[9] + a[7] * b[1] + a[8] * b[0] - a[8] * b[10] - a[9] * b[3] + a[10] * b[8] - a[11] * b[7] + a[13] * b[9] + a[14] * b[2],
a[0] * b[9] - a[2] * b[7] - a[3] * b[8] + a[7] * b[2] + a[8] * b[3] + a[9] * b[0] - a[9] * b[10] + a[10] * b[9] - a[12] * b[7] - a[13] * b[8] - a[14] * b[1],
a[0] * b[10] - a[4] * b[7] - a[5] * b[8] - a[6] * b[9] + a[7] * b[4] + a[8] * b[5] + a[9] * b[6] + a[10] * b[0] - a[11] * b[1] - a[12] * b[2] - a[13] * b[3],
a[1] * b[10] - a[4] * b[8] + a[5] * b[7] + a[7] * b[5] - a[8] * b[4] + a[10] * b[1] + a[11] * b[0] - a[12] * b[3] + a[13] * b[2] + a[14] * b[6],
a[2] * b[10] - a[4] * b[9] + a[6] * b[7] + a[7] * b[6] - a[9] * b[4] + a[10] * b[2] + a[11] * b[3] + a[12] * b[0] - a[13] * b[1] - a[14] * b[5],
a[3] * b[10] - a[5] * b[9] + a[6] * b[8] + a[8] * b[6] - a[9] * b[5] + a[10] * b[3] - a[11] * b[2] + a[12] * b[1] + a[13] * b[0] + a[14] * b[4],
a[1] * b[6] - a[2] * b[5] + a[3] * b[4] + a[4] * b[3] - a[5] * b[2] + a[6] * b[1] - a[11] * b[6] + a[12] * b[5] - a[13] * b[4],
a[1] * b[9] - a[2] * b[8] + a[3] * b[7] + a[7] * b[3] - a[8] * b[2] + a[9] * b[1] + a[11] * b[9] - a[12] * b[8] + a[13] * b[7] + a[14] * b[0] - a[14] * b[10]
);
}			
		 
		
template<> inline MVBase gp_gen<Tvt, Bst> (const MVBase& a, const MVBase& b) { 
	return gp(*(Tvt*)(&a),*(Bst*)(&b));
}			
		 
inline Tvt ip (const Tvt& a, const Tvt& b) { 
	return Tvt (
a[0] * b[0] - a[1] * b[1] - a[2] * b[2] - a[3] * b[3] + a[4] * b[7] + a[5] * b[8] + a[6] * b[9] + a[7] * b[4] + a[8] * b[5] + a[9] * b[6] + a[10] * b[10] - a[11] * b[11] - a[12] * b[12] - a[13] * b[13],
a[0] * b[1] + a[6] * b[14] + a[10] * b[11],
a[0] * b[2] - a[5] * b[14] + a[10] * b[12],
a[0] * b[3] + a[4] * b[14] + a[10] * b[13],
a[0] * b[4] - a[5] * b[11] - a[6] * b[12],
a[0] * b[5] + a[4] * b[11] - a[6] * b[13],
a[0] * b[6] + a[4] * b[12] + a[5] * b[13],
a[0] * b[7] - a[3] * b[14] + a[8] * b[11] + a[9] * b[12],
a[0] * b[8] + a[2] * b[14] - a[7] * b[11] + a[9] * b[13],
a[0] * b[9] - a[1] * b[14] - a[7] * b[12] - a[8] * b[13],
...
template<> inline MVBase ip_gen<Tvt, Tvt> (const MVBase& a, const MVBase& b) { 
	return ip(*(Tvt*)(&a),*(Tvt*)(&b));
}			
		  	
template<>
inline Tvt sp (const Tvt& tvt, const Rot& rot) {					
...
template<>
inline Tvt sp (const Tvt& tvt, const Mot& mot) {					
...
t1[0] * t2[5] - t1[1] * t2[4] + t1[3] * t2[6],
t1[0] * t2[6] - t1[2] * t2[4] - t1[3] * t2[5],
t1[0] * t2[7] + t1[1] * t2[8] + t1[2] * t2[9] - t1[3] * t2[14] + t1[4] * t2[0] - t1[4] * t2[10] - t1[5] * t2[1] + t1[5] * t2[11] - t1[6] * t2[2] + t1[6] * t2[12] - t1[7] * t2[3] + t1[7] * t2[13],
t1[0] * t2[8] - t1[1] * t2[7] + t1[2] * t2[14] + t1[3] * t2[9] + t1[4] * t2[1] - t1[4] * t2[11] + t1[5] * t2[0] - t1[5] * t2[10] - t1[6] * t2[3] + t1[6] * t2[13] + t1[7] * t2[2] - t1[7] * t2[12],
t1[0] * t2[9] - t1[1] * t2[14] - t1[2] * t2[7] - t1[3] * t2[8] + t1[4] * t2[2] - t1[4] * t2[12] + t1[5] * t2[3] - t1[5] * t2[13] + t1[6] * t2[0] - t1[6] * t2[10] - t1[7] * t2[1] + t1[7] * t2[11],
...
t1[1] * t2[6] - t1[2] * t2[5] + t1[3] * t2[4],
t1[0] * t2[14] + t1[1] * t2[9] - t1[2] * t2[8] + t1[3] * t2[7] + t1[4] * t2[3] - t1[4] * t2[13] - t1[5] * t2[2] + t1[5] * t2[12] + t1[6] * t2[1] - t1[6] * t2[11] + t1[7] * t2[0] - t1[7] * t2[10]
);
const Mot& t4 = mot;
Mot t5 = reverse( t4);
return Tvt (
...
template<>
inline Tvt sp (const Tvt& tvt, const Dil& dil) {					
...
template<>
inline Tvt sp (const Tvt& tvt, const Trv& trv) {					
					
const Trv& t1 = trv;
const Tvt& t2 = tvt;
Mtt t3 (
t1[0] * t2[0] + t1[1] * t2[7] + t1[2] * t2[8] + t1[3] * t2[9],
t1[0] * t2[1] + t1[1] * t2[8] - t1[2] * t2[7] + t1[3] * t2[14],
t1[0] * t2[2] + t1[1] * t2[9] - t1[2] * t2[14] - t1[3] * t2[7],
t1[0] * t2[3] + t1[1] * t2[14] + t1[2] * t2[9] - t1[3] * t2[8],
...
t1[0] * t2[11] - t1[1] * t2[8] + t1[2] * t2[7] - t1[3] * t2[14],
t1[0] * t2[12] - t1[1] * t2[9] + t1[2] * t2[14] + t1[3] * t2[7],
t1[0] * t2[13] - t1[1] * t2[14] - t1[2] * t2[9] + t1[3] * t2[8],
...
template<>
inline Tvt sp (const Tvt& tvt, const Mtd& mtd) {					
...
t1[0] * t2[7] + t1[1] * t2[8] + t1[2] * t2[9] - t1[3] * t2[14] + t1[4] * t2[0] - t1[4] * t2[10] - t1[5] * t2[1] + t1[5] * t2[11] - t1[6] * t2[2] + t1[6] * t2[12] + t1[7] * t2[7] + t1[8] * t2[8] + t1[9] * t2[9] - t1[10] * t2[14] - t1[11] * t2[3] + t1[11] * t2[13],
t1[0] * t2[8] - t1[1] * t2[7] + t1[2] * t2[14] + t1[3] * t2[9] + t1[4] * t2[1] - t1[4] * t2[11] + t1[5] * t2[0] - t1[5] * t2[10] - t1[6] * t2[3] + t1[6] * t2[13] + t1[7] * t2[8] - t1[8] * t2[7] + t1[9] * t2[14] + t1[10] * t2[9] + t1[11] * t2[2] - t1[11] * t2[12],
t1[0] * t2[9] - t1[1] * t2[14] - t1[2] * t2[7] - t1[3] * t2[8] + t1[4] * t2[2] - t1[4] * t2[12] + t1[5] * t2[3] - t1[5] * t2[13] + t1[6] * t2[0] - t1[6] * t2[10] + t1[7] * t2[9] - t1[8] * t2[14] - t1[9] * t2[7] - t1[10] * t2[8] - t1[11] * t2[1] + t1[11] * t2[11],
...
t1[0] * t2[14] + t1[1] * t2[9] - t1[2] * t2[8] + t1[3] * t2[7] + t1[4] * t2[3] - t1[4] * t2[13] - t1[5] * t2[2] + t1[5] * t2[12] + t1[6] * t2[1] - t1[6] * t2[11] + t1[7] * t2[14] + t1[8] * t2[9] - t1[9] * t2[8] + t1[10] * t2[7] + t1[11] * t2[0] - t1[11] * t2[10]
);
const Mtd& t4 = mtd;
Mtd t5 = reverse( t4);
return Tvt (
...
template<>
inline Tvt sp (const Tvt& tvt, const Trs& trs) {					
...
template<>
inline Tvt sp (const Tvt& tvt, const Rtc& rtc) {					
					
const Rtc& t1 = rtc;
const Tvt& t2 = tvt;
Rtc t3 (
t1[0] * t2[0] - t1[1] * t2[1] - t1[2] * t2[2] + t1[3] * t2[7] + t1[4] * t2[4] + t1[5] * t2[8] + t1[6] * t2[9] - t1[7] * t2[14] + t1[8] * t2[5] + t1[9] * t2[6] + t1[11] * t2[10] - t1[12] * t2[11] - t1[13] * t2[12] - t1[14] * t2[3] - t1[15] * t2[13],
t1[0] * t2[1] + t1[1] * t2[0] - t1[2] * t2[3] + t1[3] * t2[8] + t1[4] * t2[5] - t1[5] * t2[7] + t1[6] * t2[14] + t1[7] * t2[9] - t1[8] * t2[4] + t1[10] * t2[6] + t1[11] * t2[11] + t1[12] * t2[10] - t1[13] * t2[13] + t1[14] * t2[2] + t1[15] * t2[12],
t1[0] * t2[2] + t1[1] * t2[3] + t1[2] * t2[0] + t1[3] * t2[9] + t1[4] * t2[6] - t1[5] * t2[14] - t1[6] * t2[7] - t1[7] * t2[8] - t1[9] * t2[4] - t1[10] * t2[5] + t1[11] * t2[12] + t1[12] * t2[13] + t1[13] * t2[10] - t1[14] * t2[1] - t1[15] * t2[11],
...
t1[0] * t2[7] + t1[1] * t2[8] + t1[2] * t2[9] + t1[4] * t2[0] - t1[4] * t2[10] - t1[8] * t2[1] + t1[8] * t2[11] - t1[9] * t2[2] + t1[9] * t2[12] - t1[10] * t2[3] + t1[10] * t2[13] + t1[11] * t2[7] + t1[12] * t2[8] + t1[13] * t2[9] - t1[14] * t2[14] - t1[15] * t2[14],
...
t1[0] * t2[8] - t1[1] * t2[7] + t1[2] * t2[14] + t1[4] * t2[1] - t1[4] * t2[11] + t1[8] * t2[0] - t1[8] * t2[10] - t1[9] * t2[3] + t1[9] * t2[13] + t1[10] * t2[2] - t1[10] * t2[12] + t1[11] * t2[8] - t1[12] * t2[7] + t1[13] * t2[14] + t1[14] * t2[9] + t1[15] * t2[9],
t1[0] * t2[9] - t1[1] * t2[14] - t1[2] * t2[7] + t1[4] * t2[2] - t1[4] * t2[12] + t1[8] * t2[3] - t1[8] * t2[13] + t1[9] * t2[0] - t1[9] * t2[10] - t1[10] * t2[1] + t1[10] * t2[11] + t1[11] * t2[9] - t1[12] * t2[14] - t1[13] * t2[7] - t1[14] * t2[8] - t1[15] * t2[8],
t1[0] * t2[14] + t1[1] * t2[9] - t1[2] * t2[8] + t1[4] * t2[3] - t1[4] * t2[13] - t1[8] * t2[2] + t1[8] * t2[12] + t1[9] * t2[1] - t1[9] * t2[11] + t1[10] * t2[0] - t1[10] * t2[10] + t1[11] * t2[14] + t1[12] * t2[9] - t1[13] * t2[8] + t1[14] * t2[7] + t1[15] * t2[7],
t1[0] * t2[10] - t1[1] * t2[11] - t1[2] * t2[12] - t1[3] * t2[7] + t1[4] * t2[4] - t1[5] * t2[8] - t1[6] * t2[9] + t1[7] * t2[14] + t1[8] * t2[5] + t1[9] * t2[6] + t1[11] * t2[0] - t1[12] * t2[1] - t1[13] * t2[2] - t1[14] * t2[13] - t1[15] * t2[3],
t1[0] * t2[11] + t1[1] * t2[10] - t1[2] * t2[13] - t1[3] * t2[8] + t1[4] * t2[5] + t1[5] * t2[7] - t1[6] * t2[14] - t1[7] * t2[9] - t1[8] * t2[4] + t1[10] * t2[6] + t1[11] * t2[1] + t1[12] * t2[0] - t1[13] * t2[3] + t1[14] * t2[12] + t1[15] * t2[2],
t1[0] * t2[12] + t1[1] * t2[13] + t1[2] * t2[10] - t1[3] * t2[9] + t1[4] * t2[6] + t1[5] * t2[14] + t1[6] * t2[7] + t1[7] * t2[8] - t1[9] * t2[4] - t1[10] * t2[5] + t1[11] * t2[2] + t1[12] * t2[3] + t1[13] * t2[0] - t1[14] * t2[11] - t1[15] * t2[1],
t1[0] * t2[3] - t1[1] * t2[2] + t1[2] * t2[1] + t1[3] * t2[14] + t1[5] * t2[9] - t1[6] * t2[8] + t1[7] * t2[7] + t1[8] * t2[6] - t1[9] * t2[5] + t1[10] * t2[4] + t1[11] * t2[13] - t1[12] * t2[12] + t1[13] * t2[11] + t1[14] * t2[0] + t1[15] * t2[10],
t1[0] * t2[13] - t1[1] * t2[12] + t1[2] * t2[11] - t1[3] * t2[14] - t1[5] * t2[9] + t1[6] * t2[8] - t1[7] * t2[7] + t1[8] * t2[6] - t1[9] * t2[5] + t1[10] * t2[4] + t1[11] * t2[3] - t1[12] * t2[2] + t1[13] * t2[1] + t1[14] * t2[10] + t1[15] * t2[0]
);
const Rtc& t4 = rtc;
Rtc t5 = reverse( t4);
return Tvt (
...
template<>
inline Tvt sp (const Tvt& tvt, const Mtt& mtt) {					
...
t1[0] * t2[1] + t1[1] * t2[0] - t1[2] * t2[3] + t1[3] * t2[2] + t1[4] * t2[8] - t1[5] * t2[7] + t1[6] * t2[14] + t1[7] * t2[5] - t1[8] * t2[4] + t1[10] * t2[11] + t1[11] * t2[10] - t1[12] * t2[13] + t1[13] * t2[12] + t1[14] * t2[9] + t1[15] * t2[6],
t1[0] * t2[2] + t1[1] * t2[3] + t1[2] * t2[0] - t1[3] * t2[1] + t1[4] * t2[9] - t1[5] * t2[14] - t1[6] * t2[7] + t1[7] * t2[6] - t1[9] * t2[4] + t1[10] * t2[12] + t1[11] * t2[13] + t1[12] * t2[10] - t1[13] * t2[11] - t1[14] * t2[8] - t1[15] * t2[5],
t1[0] * t2[3] - t1[1] * t2[2] + t1[2] * t2[1] + t1[3] * t2[0] + t1[4] * t2[14] + t1[5] * t2[9] - t1[6] * t2[8] + t1[8] * t2[6] - t1[9] * t2[5] + t1[10] * t2[13] - t1[11] * t2[12] + t1[12] * t2[11] + t1[13] * t2[10] + t1[14] * t2[7] + t1[15] * t2[4],
...
t1[0] * t2[7] + t1[1] * t2[8] + t1[2] * t2[9] - t1[3] * t2[14] + t1[7] * t2[0] - t1[7] * t2[10] - t1[8] * t2[1] + t1[8] * t2[11] - t1[9] * t2[2] + t1[9] * t2[12] + t1[10] * t2[7] + t1[11] * t2[8] + t1[12] * t2[9] - t1[13] * t2[14] - t1[15] * t2[3] + t1[15] * t2[13],
t1[0] * t2[8] - t1[1] * t2[7] + t1[2] * t2[14] + t1[3] * t2[9] + t1[7] * t2[1] - t1[7] * t2[11] + t1[8] * t2[0] - t1[8] * t2[10] - t1[9] * t2[3] + t1[9] * t2[13] + t1[10] * t2[8] - t1[11] * t2[7] + t1[12] * t2[14] + t1[13] * t2[9] + t1[15] * t2[2] - t1[15] * t2[12],
t1[0] * t2[9] - t1[1] * t2[14] - t1[2] * t2[7] - t1[3] * t2[8] + t1[7] * t2[2] - t1[7] * t2[12] + t1[8] * t2[3] - t1[8] * t2[13] + t1[9] * t2[0] - t1[9] * t2[10] + t1[10] * t2[9] - t1[11] * t2[14] - t1[12] * t2[7] - t1[13] * t2[8] - t1[15] * t2[1] + t1[15] * t2[11],
...
t1[0] * t2[11] + t1[1] * t2[10] - t1[2] * t2[13] + t1[3] * t2[12] - t1[4] * t2[8] + t1[5] * t2[7] - t1[6] * t2[14] + t1[7] * t2[5] - t1[8] * t2[4] + t1[10] * t2[1] + t1[11] * t2[0] - t1[12] * t2[3] + t1[13] * t2[2] - t1[14] * t2[9] + t1[15] * t2[6],
t1[0] * t2[12] + t1[1] * t2[13] + t1[2] * t2[10] - t1[3] * t2[11] - t1[4] * t2[9] + t1[5] * t2[14] + t1[6] * t2[7] + t1[7] * t2[6] - t1[9] * t2[4] + t1[10] * t2[2] + t1[11] * t2[3] + t1[12] * t2[0] - t1[13] * t2[1] + t1[14] * t2[8] - t1[15] * t2[5],
t1[0] * t2[13] - t1[1] * t2[12] + t1[2] * t2[11] + t1[3] * t2[10] - t1[4] * t2[14] - t1[5] * t2[9] + t1[6] * t2[8] + t1[8] * t2[6] - t1[9] * t2[5] + t1[10] * t2[3] - t1[11] * t2[2] + t1[12] * t2[1] + t1[13] * t2[0] - t1[14] * t2[7] + t1[15] * t2[4],
...
t1[0] * t2[14] + t1[1] * t2[9] - t1[2] * t2[8] + t1[3] * t2[7] + t1[7] * t2[3] - t1[7] * t2[13] - t1[8] * t2[2] + t1[8] * t2[12] + t1[9] * t2[1] - t1[9] * t2[11] + t1[10] * t2[14] + t1[11] * t2[9] - t1[12] * t2[8] + t1[13] * t2[7] + t1[15] * t2[0] - t1[15] * t2[10]
);
const Mtt& t4 = mtt;
Mtt t5 = reverse( t4);
return Tvt (
...
template<>
inline Tvt sp (const Tvt& tvt, const Rtt& rtt) {					
					
const Rtt& t1 = rtt;
const Tvt& t2 = tvt;
Mtt t3 (
t1[0] * t2[0] - t1[1] * t2[1] - t1[2] * t2[2] - t1[3] * t2[3] + t1[4] * t2[7] + t1[5] * t2[8] + t1[6] * t2[9] - t1[7] * t2[14],
t1[0] * t2[1] + t1[1] * t2[0] - t1[2] * t2[3] + t1[3] * t2[2] + t1[4] * t2[8] - t1[5] * t2[7] + t1[6] * t2[14] + t1[7] * t2[9],
t1[0] * t2[2] + t1[1] * t2[3] + t1[2] * t2[0] - t1[3] * t2[1] + t1[4] * t2[9] - t1[5] * t2[14] - t1[6] * t2[7] - t1[7] * t2[8],
t1[0] * t2[3] - t1[1] * t2[2] + t1[2] * t2[1] + t1[3] * t2[0] + t1[4] * t2[14] + t1[5] * t2[9] - t1[6] * t2[8] + t1[7] * t2[7],
...
t1[0] * t2[8] - t1[1] * t2[7] + t1[2] * t2[14] + t1[3] * t2[9],
t1[0] * t2[9] - t1[1] * t2[14] - t1[2] * t2[7] - t1[3] * t2[8],
t1[0] * t2[10] - t1[1] * t2[11] - t1[2] * t2[12] - t1[3] * t2[13] - t1[4] * t2[7] - t1[5] * t2[8] - t1[6] * t2[9] + t1[7] * t2[14],
t1[0] * t2[11] + t1[1] * t2[10] - t1[2] * t2[13] + t1[3] * t2[12] - t1[4] * t2[8] + t1[5] * t2[7] - t1[6] * t2[14] - t1[7] * t2[9],
t1[0] * t2[12] + t1[1] * t2[13] + t1[2] * t2[10] - t1[3] * t2[11] - t1[4] * t2[9] + t1[5] * t2[14] + t1[6] * t2[7] + t1[7] * t2[8],
t1[0] * t2[13] - t1[1] * t2[12] + t1[2] * t2[11] + t1[3] * t2[10] - t1[4] * t2[14] - t1[5] * t2[9] + t1[6] * t2[8] - t1[7] * t2[7],
...
template<>
inline Tvt sp (const Tvt& tvt, const Rtd& rtd) {					
...
t1[0] * t2[7] + t1[1] * t2[8] + t1[2] * t2[9] - t1[3] * t2[14] + t1[4] * t2[7] + t1[5] * t2[8] + t1[6] * t2[9] - t1[7] * t2[14],
t1[0] * t2[8] - t1[1] * t2[7] + t1[2] * t2[14] + t1[3] * t2[9] + t1[4] * t2[8] - t1[5] * t2[7] + t1[6] * t2[14] + t1[7] * t2[9],
t1[0] * t2[9] - t1[1] * t2[14] - t1[2] * t2[7] - t1[3] * t2[8] + t1[4] * t2[9] - t1[5] * t2[14] - t1[6] * t2[7] - t1[7] * t2[8],
...
t1[0] * t2[14] + t1[1] * t2[9] - t1[2] * t2[8] + t1[3] * t2[7] + t1[4] * t2[14] + t1[5] * t2[9] - t1[6] * t2[8] + t1[7] * t2[7]
);
const Rtd& t4 = rtd;
Rtd t5 = reverse( t4);
return Tvt (
...
template<>
inline Tvt sp (const Tvt& tvt, const Tvd& tvd) {					
					
const Tvd& t1 = tvd;
const Tvt& t2 = tvt;
Mtt t3 (
t1[0] * t2[0] + t1[1] * t2[7] + t1[2] * t2[8] + t1[3] * t2[9] + t1[4] * t2[10],
t1[0] * t2[1] + t1[1] * t2[8] - t1[2] * t2[7] + t1[3] * t2[14] + t1[4] * t2[11],
t1[0] * t2[2] + t1[1] * t2[9] - t1[2] * t2[14] - t1[3] * t2[7] + t1[4] * t2[12],
t1[0] * t2[3] + t1[1] * t2[14] + t1[2] * t2[9] - t1[3] * t2[8] + t1[4] * t2[13],
...
t1[0] * t2[11] - t1[1] * t2[8] + t1[2] * t2[7] - t1[3] * t2[14] + t1[4] * t2[1],
t1[0] * t2[12] - t1[1] * t2[9] + t1[2] * t2[14] + t1[3] * t2[7] + t1[4] * t2[2],
t1[0] * t2[13] - t1[1] * t2[14] - t1[2] * t2[9] + t1[3] * t2[8] + t1[4] * t2[3],
t1[1] * t2[3] + t1[1] * t2[13] - t1[2] * t2[2] - t1[2] * t2[12] + t1[3] * t2[1] + t1[3] * t2[11],
...
template<>
inline Tvt sp (const Tvt& tvt, const Tsd& tsd) {					
...
template<>
inline Tvt sp (const Tvt& tvt, const Trt& trt) {					
...
t1[0] * t2[1] + t1[1] * t2[0] - t1[2] * t2[3] + t1[3] * t2[2] + t1[4] * t2[8] - t1[5] * t2[7] + t1[6] * t2[14] + t1[7] * t2[5] - t1[8] * t2[4] + t1[10] * t2[11] + t1[11] * t2[10] - t1[12] * t2[13] + t1[13] * t2[12],
t1[0] * t2[2] + t1[1] * t2[3] + t1[2] * t2[0] - t1[3] * t2[1] + t1[4] * t2[9] - t1[5] * t2[14] - t1[6] * t2[7] + t1[7] * t2[6] - t1[9] * t2[4] + t1[10] * t2[12] + t1[11] * t2[13] + t1[12] * t2[10] - t1[13] * t2[11],
t1[0] * t2[3] - t1[1] * t2[2] + t1[2] * t2[1] + t1[3] * t2[0] + t1[4] * t2[14] + t1[5] * t2[9] - t1[6] * t2[8] + t1[8] * t2[6] - t1[9] * t2[5] + t1[10] * t2[13] - t1[11] * t2[12] + t1[12] * t2[11] + t1[13] * t2[10],
...
t1[0] * t2[7] + t1[1] * t2[8] + t1[2] * t2[9] - t1[3] * t2[14] + t1[7] * t2[0] - t1[7] * t2[10] - t1[8] * t2[1] + t1[8] * t2[11] - t1[9] * t2[2] + t1[9] * t2[12] + t1[10] * t2[7] + t1[11] * t2[8] + t1[12] * t2[9] - t1[13] * t2[14],
t1[0] * t2[8] - t1[1] * t2[7] + t1[2] * t2[14] + t1[3] * t2[9] + t1[7] * t2[1] - t1[7] * t2[11] + t1[8] * t2[0] - t1[8] * t2[10] - t1[9] * t2[3] + t1[9] * t2[13] + t1[10] * t2[8] - t1[11] * t2[7] + t1[12] * t2[14] + t1[13] * t2[9],
t1[0] * t2[9] - t1[1] * t2[14] - t1[2] * t2[7] - t1[3] * t2[8] + t1[7] * t2[2] - t1[7] * t2[12] + t1[8] * t2[3] - t1[8] * t2[13] + t1[9] * t2[0] - t1[9] * t2[10] + t1[10] * t2[9] - t1[11] * t2[14] - t1[12] * t2[7] - t1[13] * t2[8],
...
t1[0] * t2[11] + t1[1] * t2[10] - t1[2] * t2[13] + t1[3] * t2[12] - t1[4] * t2[8] + t1[5] * t2[7] - t1[6] * t2[14] + t1[7] * t2[5] - t1[8] * t2[4] + t1[10] * t2[1] + t1[11] * t2[0] - t1[12] * t2[3] + t1[13] * t2[2],
t1[0] * t2[12] + t1[1] * t2[13] + t1[2] * t2[10] - t1[3] * t2[11] - t1[4] * t2[9] + t1[5] * t2[14] + t1[6] * t2[7] + t1[7] * t2[6] - t1[9] * t2[4] + t1[10] * t2[2] + t1[11] * t2[3] + t1[12] * t2[0] - t1[13] * t2[1],
t1[0] * t2[13] - t1[1] * t2[12] + t1[2] * t2[11] + t1[3] * t2[10] - t1[4] * t2[14] - t1[5] * t2[9] + t1[6] * t2[8] + t1[8] * t2[6] - t1[9] * t2[5] + t1[10] * t2[3] - t1[11] * t2[2] + t1[12] * t2[1] + t1[13] * t2[0],
...
t1[0] * t2[14] + t1[1] * t2[9] - t1[2] * t2[8] + t1[3] * t2[7] + t1[7] * t2[3] - t1[7] * t2[13] - t1[8] * t2[2] + t1[8] * t2[12] + t1[9] * t2[1] - t1[9] * t2[11] + t1[10] * t2[14] + t1[11] * t2[9] - t1[12] * t2[8] + t1[13] * t2[7]
);
const Trt& t4 = trt;
Trt t5 = reverse( t4);
return Tvt (
...
template<>
inline Tvt sp (const Tvt& tvt, const Rvd& rvd) {					
					
const Rvd& t1 = rvd;
const Tvt& t2 = tvt;
Mtt t3 (
t1[0] * t2[0] - t1[1] * t2[1] - t1[2] * t2[2] - t1[3] * t2[3] + t1[4] * t2[7] + t1[5] * t2[8] + t1[6] * t2[9] + t1[7] * t2[10] - t1[8] * t2[11] - t1[9] * t2[12] - t1[10] * t2[13] - t1[11] * t2[14],
t1[0] * t2[1] + t1[1] * t2[0] - t1[2] * t2[3] + t1[3] * t2[2] + t1[4] * t2[8] - t1[5] * t2[7] + t1[6] * t2[14] + t1[7] * t2[11] + t1[8] * t2[10] - t1[9] * t2[13] + t1[10] * t2[12] + t1[11] * t2[9],
t1[0] * t2[2] + t1[1] * t2[3] + t1[2] * t2[0] - t1[3] * t2[1] + t1[4] * t2[9] - t1[5] * t2[14] - t1[6] * t2[7] + t1[7] * t2[12] + t1[8] * t2[13] + t1[9] * t2[10] - t1[10] * t2[11] - t1[11] * t2[8],
t1[0] * t2[3] - t1[1] * t2[2] + t1[2] * t2[1] + t1[3] * t2[0] + t1[4] * t2[14] + t1[5] * t2[9] - t1[6] * t2[8] + t1[7] * t2[13] - t1[8] * t2[12] + t1[9] * t2[11] + t1[10] * t2[10] + t1[11] * t2[7],
...
t1[0] * t2[7] + t1[1] * t2[8] + t1[2] * t2[9] - t1[3] * t2[14] + t1[7] * t2[7] + t1[8] * t2[8] + t1[9] * t2[9] - t1[10] * t2[14],
t1[0] * t2[8] - t1[1] * t2[7] + t1[2] * t2[14] + t1[3] * t2[9] + t1[7] * t2[8] - t1[8] * t2[7] + t1[9] * t2[14] + t1[10] * t2[9],
t1[0] * t2[9] - t1[1] * t2[14] - t1[2] * t2[7] - t1[3] * t2[8] + t1[7] * t2[9] - t1[8] * t2[14] - t1[9] * t2[7] - t1[10] * t2[8],
t1[0] * t2[10] - t1[1] * t2[11] - t1[2] * t2[12] - t1[3] * t2[13] - t1[4] * t2[7] - t1[5] * t2[8] - t1[6] * t2[9] + t1[7] * t2[0] - t1[8] * t2[1] - t1[9] * t2[2] - t1[10] * t2[3] + t1[11] * t2[14],
t1[0] * t2[11] + t1[1] * t2[10] - t1[2] * t2[13] + t1[3] * t2[12] - t1[4] * t2[8] + t1[5] * t2[7] - t1[6] * t2[14] + t1[7] * t2[1] + t1[8] * t2[0] - t1[9] * t2[3] + t1[10] * t2[2] - t1[11] * t2[9],
t1[0] * t2[12] + t1[1] * t2[13] + t1[2] * t2[10] - t1[3] * t2[11] - t1[4] * t2[9] + t1[5] * t2[14] + t1[6] * t2[7] + t1[7] * t2[2] + t1[8] * t2[3] + t1[9] * t2[0] - t1[10] * t2[1] + t1[11] * t2[8],
t1[0] * t2[13] - t1[1] * t2[12] + t1[2] * t2[11] + t1[3] * t2[10] - t1[4] * t2[14] - t1[5] * t2[9] + t1[6] * t2[8] + t1[7] * t2[3] - t1[8] * t2[2] + t1[9] * t2[1] + t1[10] * t2[0] - t1[11] * t2[7],
...
t1[0] * t2[14] + t1[1] * t2[9] - t1[2] * t2[8] + t1[3] * t2[7] + t1[7] * t2[14] + t1[8] * t2[9] - t1[9] * t2[8] + t1[10] * t2[7]
);
const Rvd& t4 = rvd;
Rvd t5 = reverse( t4);
return Tvt (
...
template<>
inline Tvt sp (const Tvt& tvt, const Tst& tst) {					
					
const Tst& t1 = tst;
const Tvt& t2 = tvt;
Mtt t3 (
t1[0] * t2[0] - t1[1] * t2[1] - t1[2] * t2[2] - t1[3] * t2[3] + t1[4] * t2[7] + t1[5] * t2[8] + t1[6] * t2[9] + t1[7] * t2[4] + t1[8] * t2[5] + t1[9] * t2[6] + t1[10] * t2[10] - t1[11] * t2[11] - t1[12] * t2[12] - t1[13] * t2[13] - t1[14] * t2[14],
t1[0] * t2[1] + t1[1] * t2[0] - t1[2] * t2[3] + t1[3] * t2[2] + t1[4] * t2[8] - t1[5] * t2[7] + t1[6] * t2[14] + t1[7] * t2[5] - t1[8] * t2[4] + t1[10] * t2[11] + t1[11] * t2[10] - t1[12] * t2[13] + t1[13] * t2[12] + t1[14] * t2[9],
t1[0] * t2[2] + t1[1] * t2[3] + t1[2] * t2[0] - t1[3] * t2[1] + t1[4] * t2[9] - t1[5] * t2[14] - t1[6] * t2[7] + t1[7] * t2[6] - t1[9] * t2[4] + t1[10] * t2[12] + t1[11] * t2[13] + t1[12] * t2[10] - t1[13] * t2[11] - t1[14] * t2[8],
t1[0] * t2[3] - t1[1] * t2[2] + t1[2] * t2[1] + t1[3] * t2[0] + t1[4] * t2[14] + t1[5] * t2[9] - t1[6] * t2[8] + t1[8] * t2[6] - t1[9] * t2[5] + t1[10] * t2[13] - t1[11] * t2[12] + t1[12] * t2[11] + t1[13] * t2[10] + t1[14] * t2[7],
t1[0] * t2[4] + t1[1] * t2[5] + t1[2] * t2[6] + t1[4] * t2[0] + t1[4] * t2[10] - t1[5] * t2[1] - t1[5] * t2[11] - t1[6] * t2[2] - t1[6] * t2[12] - t1[10] * t2[4] - t1[11] * t2[5] - t1[12] * t2[6] - t1[14] * t2[3] - t1[14] * t2[13],
t1[0] * t2[5] - t1[1] * t2[4] + t1[3] * t2[6] + t1[4] * t2[1] + t1[4] * t2[11] + t1[5] * t2[0] + t1[5] * t2[10] - t1[6] * t2[3] - t1[6] * t2[13] - t1[10] * t2[5] + t1[11] * t2[4] - t1[13] * t2[6] + t1[14] * t2[2] + t1[14] * t2[12],
t1[0] * t2[6] - t1[2] * t2[4] - t1[3] * t2[5] + t1[4] * t2[2] + t1[4] * t2[12] + t1[5] * t2[3] + t1[5] * t2[13] + t1[6] * t2[0] + t1[6] * t2[10] - t1[10] * t2[6] + t1[12] * t2[4] + t1[13] * t2[5] - t1[14] * t2[1] - t1[14] * t2[11],
t1[0] * t2[7] + t1[1] * t2[8] + t1[2] * t2[9] - t1[3] * t2[14] + t1[7] * t2[0] - t1[7] * t2[10] - t1[8] * t2[1] + t1[8] * t2[11] - t1[9] * t2[2] + t1[9] * t2[12] + t1[10] * t2[7] + t1[11] * t2[8] + t1[12] * t2[9] - t1[13] * t2[14],
...
t1[0] * t2[9] - t1[1] * t2[14] - t1[2] * t2[7] - t1[3] * t2[8] + t1[7] * t2[2] - t1[7] * t2[12] + t1[8] * t2[3] - t1[8] * t2[13] + t1[9] * t2[0] - t1[9] * t2[10] + t1[10] * t2[9] - t1[11] * t2[14] - t1[12] * t2[7] - t1[13] * t2[8],
t1[0] * t2[10] - t1[1] * t2[11] - t1[2] * t2[12] - t1[3] * t2[13] - t1[4] * t2[7] - t1[5] * t2[8] - t1[6] * t2[9] + t1[7] * t2[4] + t1[8] * t2[5] + t1[9] * t2[6] + t1[10] * t2[0] - t1[11] * t2[1] - t1[12] * t2[2] - t1[13] * t2[3] + t1[14] * t2[14],
t1[0] * t2[11] + t1[1] * t2[10] - t1[2] * t2[13] + t1[3] * t2[12] - t1[4] * t2[8] + t1[5] * t2[7] - t1[6] * t2[14] + t1[7] * t2[5] - t1[8] * t2[4] + t1[10] * t2[1] + t1[11] * t2[0] - t1[12] * t2[3] + t1[13] * t2[2] - t1[14] * t2[9],
t1[0] * t2[12] + t1[1] * t2[13] + t1[2] * t2[10] - t1[3] * t2[11] - t1[4] * t2[9] + t1[5] * t2[14] + t1[6] * t2[7] + t1[7] * t2[6] - t1[9] * t2[4] + t1[10] * t2[2] + t1[11] * t2[3] + t1[12] * t2[0] - t1[13] * t2[1] + t1[14] * t2[8],
t1[0] * t2[13] - t1[1] * t2[12] + t1[2] * t2[11] + t1[3] * t2[10] - t1[4] * t2[14] - t1[5] * t2[9] + t1[6] * t2[8] + t1[8] * t2[6] - t1[9] * t2[5] + t1[10] * t2[3] - t1[11] * t2[2] + t1[12] * t2[1] + t1[13] * t2[0] - t1[14] * t2[7],
t1[1] * t2[6] - t1[2] * t2[5] + t1[3] * t2[4] + t1[4] * t2[3] + t1[4] * t2[13] - t1[5] * t2[2] - t1[5] * t2[12] + t1[6] * t2[1] + t1[6] * t2[11] - t1[11] * t2[6] + t1[12] * t2[5] - t1[13] * t2[4] + t1[14] * t2[0] + t1[14] * t2[10],
t1[0] * t2[14] + t1[1] * t2[9] - t1[2] * t2[8] + t1[3] * t2[7] + t1[7] * t2[3] - t1[7] * t2[13] - t1[8] * t2[2] + t1[8] * t2[12] + t1[9] * t2[1] - t1[9] * t2[11] + t1[10] * t2[14] + t1[11] * t2[9] - t1[12] * t2[8] + t1[13] * t2[7]
);
const Tst& t4 = tst;
...
template<>
inline Tvt sp (const Tvt& tvt, const Bst& bst) {					
					
const Bst& t1 = bst;
const Tvt& t2 = tvt;
Mtt t3 (
t1[0] * t2[0] - t1[1] * t2[1] - t1[2] * t2[2] - t1[3] * t2[3] + t1[4] * t2[7] + t1[5] * t2[8] + t1[6] * t2[9] + t1[7] * t2[4] + t1[8] * t2[5] + t1[9] * t2[6] + t1[10] * t2[10],
t1[0] * t2[1] + t1[1] * t2[0] - t1[2] * t2[3] + t1[3] * t2[2] + t1[4] * t2[8] - t1[5] * t2[7] + t1[6] * t2[14] + t1[7] * t2[5] - t1[8] * t2[4] + t1[10] * t2[11],
t1[0] * t2[2] + t1[1] * t2[3] + t1[2] * t2[0] - t1[3] * t2[1] + t1[4] * t2[9] - t1[5] * t2[14] - t1[6] * t2[7] + t1[7] * t2[6] - t1[9] * t2[4] + t1[10] * t2[12],
t1[0] * t2[3] - t1[1] * t2[2] + t1[2] * t2[1] + t1[3] * t2[0] + t1[4] * t2[14] + t1[5] * t2[9] - t1[6] * t2[8] + t1[8] * t2[6] - t1[9] * t2[5] + t1[10] * t2[13],
...
t1[0] * t2[7] + t1[1] * t2[8] + t1[2] * t2[9] - t1[3] * t2[14] + t1[7] * t2[0] - t1[7] * t2[10] - t1[8] * t2[1] + t1[8] * t2[11] - t1[9] * t2[2] + t1[9] * t2[12] + t1[10] * t2[7],
t1[0] * t2[8] - t1[1] * t2[7] + t1[2] * t2[14] + t1[3] * t2[9] + t1[7] * t2[1] - t1[7] * t2[11] + t1[8] * t2[0] - t1[8] * t2[10] - t1[9] * t2[3] + t1[9] * t2[13] + t1[10] * t2[8],
t1[0] * t2[9] - t1[1] * t2[14] - t1[2] * t2[7] - t1[3] * t2[8] + t1[7] * t2[2] - t1[7] * t2[12] + t1[8] * t2[3] - t1[8] * t2[13] + t1[9] * t2[0] - t1[9] * t2[10] + t1[10] * t2[9],
t1[0] * t2[10] - t1[1] * t2[11] - t1[2] * t2[12] - t1[3] * t2[13] - t1[4] * t2[7] - t1[5] * t2[8] - t1[6] * t2[9] + t1[7] * t2[4] + t1[8] * t2[5] + t1[9] * t2[6] + t1[10] * t2[0],
t1[0] * t2[11] + t1[1] * t2[10] - t1[2] * t2[13] + t1[3] * t2[12] - t1[4] * t2[8] + t1[5] * t2[7] - t1[6] * t2[14] + t1[7] * t2[5] - t1[8] * t2[4] + t1[10] * t2[1],
t1[0] * t2[12] + t1[1] * t2[13] + t1[2] * t2[10] - t1[3] * t2[11] - t1[4] * t2[9] + t1[5] * t2[14] + t1[6] * t2[7] + t1[7] * t2[6] - t1[9] * t2[4] + t1[10] * t2[2],
t1[0] * t2[13] - t1[1] * t2[12] + t1[2] * t2[11] + t1[3] * t2[10] - t1[4] * t2[14] - t1[5] * t2[9] + t1[6] * t2[8] + t1[8] * t2[6] - t1[9] * t2[5] + t1[10] * t2[3],
t1[1] * t2[6] - t1[2] * t2[5] + t1[3] * t2[4] + t1[4] * t2[3] + t1[4] * t2[13] - t1[5] * t2[2] - t1[5] * t2[12] + t1[6] * t2[1] + t1[6] * t2[11],
t1[0] * t2[14] + t1[1] * t2[9] - t1[2] * t2[8] + t1[3] * t2[7] + t1[7] * t2[3] - t1[7] * t2[13] - t1[8] * t2[2] + t1[8] * t2[12] + t1[9] * t2[1] - t1[9] * t2[11] + t1[10] * t2[14]
);
const Bst& t4 = bst;
Bst t5 = reverse( t4);
return Tvt (
...
template<>
inline Tvt re (const Tvt& tvt, const Vec& vec) {					
...
t1[0] * t3[6] - t1[2] * t3[4],
t1[1] * t3[6] - t1[2] * t3[5],
t1[0] * t3[8] - t1[1] * t3[7] + t1[2] * t3[14],
t1[0] * t3[9] - t1[1] * t3[14] - t1[2] * t3[7],
t1[0] * t3[14] + t1[1] * t3[9] - t1[2] * t3[8],
...
template<>
inline Tvt re (const Tvt& tvt, const Dlp& dlp) {					
...
t1[0] * t3[6] - t1[2] * t3[4],
t1[1] * t3[6] - t1[2] * t3[5],
t1[0] * t3[8] - t1[1] * t3[7] + t1[2] * t3[14] + t1[3] * t3[1] - t1[3] * t3[11],
t1[0] * t3[9] - t1[1] * t3[14] - t1[2] * t3[7] + t1[3] * t3[2] - t1[3] * t3[12],
t1[0] * t3[14] + t1[1] * t3[9] - t1[2] * t3[8] + t1[3] * t3[3] - t1[3] * t3[13],
...
template<>
inline Tvt re (const Tvt& tvt, const Pln& pln) {					
...
t1[0] * t3[4] - t1[2] * t3[6],
t1[1] * t3[4] + t1[2] * t3[5],
t1[0] * t3[8] + t1[1] * t3[9] - t1[2] * t3[14] - t1[3] * t3[3] + t1[3] * t3[13],
 - t1[0] * t3[7] + t1[1] * t3[14] + t1[2] * t3[9] + t1[3] * t3[2] - t1[3] * t3[12],
 - t1[0] * t3[14] - t1[1] * t3[7] - t1[2] * t3[8] - t1[3] * t3[1] + t1[3] * t3[11],
...
template<>
inline Tvt re (const Tvt& tvt, const Dll& dll) {					
...
t1[0] * t3[5] + t1[1] * t3[6],
 - t1[0] * t3[4] + t1[2] * t3[6],
 - t1[1] * t3[4] - t1[2] * t3[5],
t1[0] * t3[8] + t1[1] * t3[9] - t1[2] * t3[14] + t1[3] * t3[0] - t1[3] * t3[10] - t1[4] * t3[1] + t1[4] * t3[11] - t1[5] * t3[2] + t1[5] * t3[12],
 - t1[0] * t3[7] + t1[1] * t3[14] + t1[2] * t3[9] + t1[3] * t3[1] - t1[3] * t3[11] + t1[4] * t3[0] - t1[4] * t3[10] - t1[5] * t3[3] + t1[5] * t3[13],
 - t1[0] * t3[14] - t1[1] * t3[7] - t1[2] * t3[8] + t1[3] * t3[2] - t1[3] * t3[12] + t1[4] * t3[3] - t1[4] * t3[13] + t1[5] * t3[0] - t1[5] * t3[10],
...
template<>
inline Tvt re (const Tvt& tvt, const Lin& lin) {					
...
t1[0] * t3[5] + t1[1] * t3[6] + t1[3] * t3[10] - t1[4] * t3[11] - t1[5] * t3[12],
 ...
 - t1[3] * t3[6] + t1[5] * t3[4],
 - t1[4] * t3[6] + t1[5] * t3[5],
t1[0] * t3[0] - t1[0] * t3[10] - t1[1] * t3[3] + t1[1] * t3[13] + t1[2] * t3[2] - t1[2] * t3[12] + t1[3] * t3[8] - t1[4] * t3[7] + t1[5] * t3[14],
t1[0] * t3[3] - t1[0] * t3[13] + t1[1] * t3[0] - t1[1] * t3[10] - t1[2] * t3[1] + t1[2] * t3[11] + t1[3] * t3[9] - t1[4] * t3[14] - t1[5] * t3[7],
 - t1[0] * t3[2] + t1[0] * t3[12] + t1[1] * t3[1] - t1[1] * t3[11] + t1[2] * t3[0] - t1[2] * t3[10] + t1[3] * t3[14] + t1[4] * t3[9] - t1[5] * t3[8],
...
template<>
inline Tvt re (const Tvt& tvt, const Pnt& pnt) {					
...
t1[0] * t3[8] - t1[1] * t3[7] + t1[2] * t3[14] + t1[4] * t3[1] - t1[4] * t3[11],
t1[0] * t3[9] - t1[1] * t3[14] - t1[2] * t3[7] + t1[4] * t3[2] - t1[4] * t3[12],
t1[0] * t3[14] + t1[1] * t3[9] - t1[2] * t3[8] + t1[4] * t3[3] - t1[4] * t3[13],
...
template<>
inline Tvt re (const Tvt& tvt, const Par& par) {					
...
t1[0] * t3[0] - t1[1] * t3[3] + t1[2] * t3[2] + t1[3] * t3[8] - t1[4] * t3[7] + t1[5] * t3[14] + t1[6] * t3[5] - t1[7] * t3[4] + t1[9] * t3[11],
t1[0] * t3[3] + t1[1] * t3[0] - t1[2] * t3[1] + t1[3] * t3[9] - t1[4] * t3[14] - t1[5] * t3[7] + t1[6] * t3[6] - t1[8] * t3[4] + t1[9] * t3[12],
 - t1[0] * t3[2] + t1[1] * t3[1] + t1[2] * t3[0] + t1[3] * t3[14] + t1[4] * t3[9] - t1[5] * t3[8] + t1[7] * t3[6] - t1[8] * t3[5] + t1[9] * t3[13],
...
t1[0] * t3[8] + t1[1] * t3[9] - t1[2] * t3[14] + t1[6] * t3[0] - t1[6] * t3[10] - t1[7] * t3[1] + t1[7] * t3[11] - t1[8] * t3[2] + t1[8] * t3[12] + t1[9] * t3[7],
 - t1[0] * t3[7] + t1[1] * t3[14] + t1[2] * t3[9] + t1[6] * t3[1] - t1[6] * t3[11] + t1[7] * t3[0] - t1[7] * t3[10] - t1[8] * t3[3] + t1[8] * t3[13] + t1[9] * t3[8],
 - t1[0] * t3[14] - t1[1] * t3[7] - t1[2] * t3[8] + t1[6] * t3[2] - t1[6] * t3[12] + t1[7] * t3[3] - t1[7] * t3[13] + t1[8] * t3[0] - t1[8] * t3[10] + t1[9] * t3[9],
 - t1[0] * t3[11] - t1[1] * t3[12] - t1[2] * t3[13] - t1[3] * t3[7] - t1[4] * t3[8] - t1[5] * t3[9] + t1[6] * t3[4] + t1[7] * t3[5] + t1[8] * t3[6] + t1[9] * t3[0],
t1[0] * t3[10] - t1[1] * t3[13] + t1[2] * t3[12] - t1[3] * t3[8] + t1[4] * t3[7] - t1[5] * t3[14] + t1[6] * t3[5] - t1[7] * t3[4] + t1[9] * t3[1],
t1[0] * t3[13] + t1[1] * t3[10] - t1[2] * t3[11] - t1[3] * t3[9] + t1[4] * t3[14] + t1[5] * t3[7] + t1[6] * t3[6] - t1[8] * t3[4] + t1[9] * t3[2],
 - t1[0] * t3[12] + t1[1] * t3[11] + t1[2] * t3[10] - t1[3] * t3[14] - t1[4] * t3[9] + t1[5] * t3[8] + t1[7] * t3[6] - t1[8] * t3[5] + t1[9] * t3[3],
t1[0] * t3[6] - t1[1] * t3[5] + t1[2] * t3[4] + t1[3] * t3[3] + t1[3] * t3[13] - t1[4] * t3[2] - t1[4] * t3[12] + t1[5] * t3[1] + t1[5] * t3[11],
t1[0] * t3[9] - t1[1] * t3[8] + t1[2] * t3[7] + t1[6] * t3[3] - t1[6] * t3[13] - t1[7] * t3[2] + t1[7] * t3[12] + t1[8] * t3[1] - t1[8] * t3[11] + t1[9] * t3[14]
);
const Par& t5 = par;
Par t6 = reverse( t5);
return Tvt (
...
template<>
inline Tvt re (const Tvt& tvt, const Cir& cir) {					
					
const Cir& t1 = cir;
const Tvt& t2 = tvt;
Tvt t3 = involute( t2);
Rtc t4 (
t1[0] * t3[8] + t1[1] * t3[9] - t1[2] * t3[14] + t1[3] * t3[5] + t1[4] * t3[6] + t1[6] * t3[10] - t1[7] * t3[11] - t1[8] * t3[12] - t1[9] * t3[3],
 - t1[0] * t3[7] + t1[1] * t3[14] + t1[2] * t3[9] - t1[3] * t3[4] + t1[5] * t3[6] + t1[6] * t3[11] + t1[7] * t3[10] - t1[8] * t3[13] + t1[9] * t3[2],
 - t1[0] * t3[14] - t1[1] * t3[7] - t1[2] * t3[8] - t1[4] * t3[4] - t1[5] * t3[5] + t1[6] * t3[12] + t1[7] * t3[13] + t1[8] * t3[10] - t1[9] * t3[1],
 - t1[0] * t3[1] - t1[0] * t3[11] - t1[1] * t3[2] - t1[1] * t3[12] - t1[2] * t3[3] - t1[2] * t3[13] - t1[6] * t3[4] - t1[7] * t3[5] - t1[8] * t3[6],
 - t1[3] * t3[1] + t1[3] * t3[11] - t1[4] * t3[2] + t1[4] * t3[12] - t1[5] * t3[3] + t1[5] * t3[13] + t1[6] * t3[7] + t1[7] * t3[8] + t1[8] * t3[9] - t1[9] * t3[14],
...
t1[3] * t3[0] - t1[3] * t3[10] - t1[4] * t3[3] + t1[4] * t3[13] + t1[5] * t3[2] - t1[5] * t3[12] + t1[6] * t3[8] - t1[7] * t3[7] + t1[8] * t3[14] + t1[9] * t3[9],
t1[3] * t3[3] - t1[3] * t3[13] + t1[4] * t3[0] - t1[4] * t3[10] - t1[5] * t3[1] + t1[5] * t3[11] + t1[6] * t3[9] - t1[7] * t3[14] - t1[8] * t3[7] - t1[9] * t3[8],
 - t1[3] * t3[2] + t1[3] * t3[12] + t1[4] * t3[1] - t1[4] * t3[11] + t1[5] * t3[0] - t1[5] * t3[10] + t1[6] * t3[14] + t1[7] * t3[9] - t1[8] * t3[8] + t1[9] * t3[7],
 - t1[0] * t3[8] - t1[1] * t3[9] + t1[2] * t3[14] + t1[3] * t3[5] + t1[4] * t3[6] + t1[6] * t3[0] - t1[7] * t3[1] - t1[8] * t3[2] - t1[9] * t3[13],
t1[0] * t3[7] - t1[1] * t3[14] - t1[2] * t3[9] - t1[3] * t3[4] + t1[5] * t3[6] + t1[6] * t3[1] + t1[7] * t3[0] - t1[8] * t3[3] + t1[9] * t3[12],
t1[0] * t3[14] + t1[1] * t3[7] + t1[2] * t3[8] - t1[4] * t3[4] - t1[5] * t3[5] + t1[6] * t3[2] + t1[7] * t3[3] + t1[8] * t3[0] - t1[9] * t3[11],
...
template<>
inline Tvt re (const Tvt& tvt, const Sph& sph) {					
...
t1[0] * t3[8] + t1[1] * t3[9] - t1[2] * t3[14] - t1[4] * t3[3] + t1[4] * t3[13],
 - t1[0] * t3[7] + t1[1] * t3[14] + t1[2] * t3[9] + t1[4] * t3[2] - t1[4] * t3[12],
 - t1[0] * t3[14] - t1[1] * t3[7] - t1[2] * t3[8] - t1[4] * t3[1] + t1[4] * t3[11],
