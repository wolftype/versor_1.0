...
template<> void Draw :: Immediate (const Vec& s){
    Glyph::Dir( s);
}

template<> void Draw :: Immediate (const Drv& s){
    Glyph::Arr( s, 1 );
}

template<> void Draw :: Immediate (const Biv& s){
...
template<> void Draw :: Immediate (const Pnt& s){
...
template<> void Draw :: Immediate (const Par& s){
        //Is Imaginary?
...
template<> void Draw :: Immediate (const Cir& s){
        Biv b = Ro::dir( s );
...
template<> void Draw :: Immediate (const Sph& s){
    Dls ts = Op::dl( s );
    Pnt p = Ro::cen(ts);
    Glyph::Point(p);
...
template<> void Draw :: Immediate (const Pln& s){
//    Drv d	= Fl::dir( s );
...
template<> void Draw :: Immediate (const Dlp& s){
...
template<> void Draw :: Immediate (const Lin& s){
    Drv d	= Fl::dir( s );
...
template<> void Draw :: Immediate (const Dll& s){
    Drv d = Fl::dir( s );
...
template<> void Draw :: Immediate (const Tnv& s){
    Glyph::DashedLine( s );
    glTranslated(s[0], s[1], s[2]);
    Glyph::SolidSphere(.1,5,5);
}

template<> void Draw :: Immediate (const Tnb& s){
//    Biv b(s); b.draw(0,0,1,.5);
}

template<> void Draw :: Immediate (const Flp& s){
//    s.null().draw(r,g,b,a);
}        
