	...
	Assign Rot_Trv_Pss :: assign;
	bool Rot_Trv_Pss :: bound = 0; 

	void Rot_Trv_Pss :: Bind(){
		if (!bound) {
			cout << "binding Rot_Trv_Pss" << endl;
			Conga::Line().bindFunc("conga_assign_Rot_Trv_Pss_fn",   &assign.ptr.get);
			bound = 1;
		}
	}
