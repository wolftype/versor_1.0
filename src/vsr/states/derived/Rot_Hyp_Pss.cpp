	...
	Assign Rot_Hyp_Pss :: assign;
	bool Rot_Hyp_Pss :: bound = 0; 

	void Rot_Hyp_Pss :: Bind(){
		if (!bound) {
			cout << "binding Rot_Hyp_Pss" << endl;
			Conga::Line().bindFunc("conga_assign_Rot_Hyp_Pss_fn",   &assign.ptr.get);
			bound = 1;
		}
	}
