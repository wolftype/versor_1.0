	...
	Assign Mnk_Pnt_Lin :: assign;
	bool Mnk_Pnt_Lin :: bound = 0; 

	void Mnk_Pnt_Lin :: Bind(){
		if (!bound) {
			cout << "binding Mnk_Pnt_Lin" << endl;
			Conga::Line().bindFunc("conga_assign_Mnk_Pnt_Lin_fn",   &assign.ptr.get);
			bound = 1;
		}
	}
