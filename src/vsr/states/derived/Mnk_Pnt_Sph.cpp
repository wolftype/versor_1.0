	...
	Assign Mnk_Pnt_Sph :: assign;
	bool Mnk_Pnt_Sph :: bound = 0; 

	void Mnk_Pnt_Sph :: Bind(){
		if (!bound) {
			//cout << "binding Mnk_Pnt_Sph" << endl;
			Conga::Line().bindFunc("conga_assign_Mnk_Pnt_Sph_fn",   &assign.ptr.get);
			bound = 1;
		}
	}
